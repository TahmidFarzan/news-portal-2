...
return [
    ...
    'breaking_news'   => [
        ...
        'update'  => [
            ...
            'failed'  => 'Failed to update breaking news.',
        ],

        'trash'   => [
            'success' => 'Breaking news trash successfully.',
            'failed'  => 'Failed to trash breaking news.',
        ],

        'restore' => [
            'success' => 'Breaking news restore successfully.',
            'failed'  => 'Failed to restore breaking news.',
        ],
    ...
    'survey'          => [
        ...
        'delete'   => [
            ...
            'failed'  => 'Failed to delete survey.',
        ],

        'active'   => [
            'success' => 'Survey active successfully.',
            'failed'  => 'Failed to active survey.',
        ],

        'inactive' => [
            'success' => 'Survey inactive successfully.',
            'failed'  => 'Failed to inactive survey.',
        ],
    ],

    'survey-question' => [
        'save'   => [
            'success' => 'Survey question saved successfully.',
            'failed'  => 'Failed to save survey question.',
        ],
    ...
    'quiz-question' => [
        ...
        'reorder' => [
            'success' => 'Quiz question reorder successfully.',
            'failed'  => 'Failed to reorder quiz question.',
        ],
    ],
    ...
    'site'            => [
        ...
        'survey' => [
            'survey-question' => [
                "success" => 'Survey question has been sumited.',
                "failed" => 'Fail to submit survey question.',
