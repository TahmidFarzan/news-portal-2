...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menuTypeHeader    = MenuType::where("name", MenuHelper::TYPE_HEADER)->first();
        $menuTypeTopBar    = MenuType::where("name", MenuHelper::TYPE_TOPBAR)->first();
        $menuTypeFooter    = MenuType::where("name", MenuHelper::TYPE_FOOTER)->first();
        $menuTypeOffCanvas = MenuType::where("name", MenuHelper::TYPE_OFFCANVAS)->first();
