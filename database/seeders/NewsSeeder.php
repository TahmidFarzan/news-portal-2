...
class NewsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($newsStoriesByLanguageGroups as $newsStoriesByLanguageGroup) {
            ...
            $newses      = $newsStoriesByLanguageGroup->newses;
            ...
            foreach ($newses as $index => $news) {
                ...
                if ($contributorIds && $index >= $totalNewses - 11) {
            ...
            (object) [
                ...
                'newses'        => collect([
                    ...
                    (object) [
                        ...
                        'title'            => "PM Opens Four-Day DC Conference in Dhaka",
                        'sub_title'        => "Field officials told to deliver government pledges",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "National",
                        'title'            => "PM Says Government Inherited Tk30 Lakh Crore Debt Burden",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "National",
                        'title'            => "PM Urges DCs to Work With Spirit of Progress",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "National",
                        'title'            => "Dhaka-Sylhet Road and Rail Connectivity Upgrade Planned",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "National",
                        'title'            => "DC Conference Begins With 498 Public Service Proposals",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Jamaat Secretary General Warns of Constitutional Crisis",
                        'sub_title'        => "Party alleges referendum verdict is being ignored",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Politics",
                        'title'            => "Jamaat Urges Government to Protect Press Freedom",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Politics",
                        'title'            => "Information Minister Says Free Media Is BNP Commitment",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Politics",
                        'title'            => "Mirza Fakhrul Says Bangladesh Is Rebounding From Past Crisis",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Politics",
                        'title'            => "Moyeen Khan Calls Workers the Nation’s Builders",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "PM Issues Directives on Government Priorities for Field Administration",
                        'sub_title'        => "DCs told to make administration dynamic and people-friendly",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Government",
                        'title'            => "Government Measures Help Restore Economic Momentum",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Government",
                        'title'            => "Government Approved Procurement of 9,000MT Lentils",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Government",
                        'title'            => "Home Minister Visits Ramna Model Police Station",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Government",
                        'title'            => "Chief Justice to Meet DCs and Divisional Commissioners",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "51 Crime Suspects Arrested in Tejgaon Police Drives",
                        'sub_title'        => "DMP conducts coordinated drives in several crime-prone areas",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Law & Order",
                        'title'            => "Three Arrested Over Arson at Primary Education Store",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Law & Order",
                        'title'            => "Two Arrested in Demra With Firearms and Walkie-Talkie",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Law & Order",
                        'title'            => "PBI Arrests One in Tk60 Lakh Australia Job Scam",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Law & Order",
                        'title'            => "DB Arrests One With 1,000 Yaba Pills in Rajshahi",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "EC Gazettes 49 Women MPs Elected Unopposed",
                        'sub_title'        => "Reserved seat voting not required after uncontested nominations",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Elections",
                        'title'            => "EC Sets May 12 Poll Date for Women’s Reserved Seats",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Elections",
                        'title'            => "EC Publishes Voter List for Women’s Reserved Seat Election",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Elections",
                        'title'            => "Low Turnout and Irregularity Claims Mark Bogura-6 By-Polls",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Elections",
                        'title'            => "59.44% Turnout Recorded in 13th National Election",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Government Opens DC Conference With Policy Directives",
                        'sub_title'        => "Field administration asked to align work with national priorities",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Public Policy",
                        'title'            => "DSCC Launches Hawker Rehabilitation Under New Policy Framework",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Public Policy",
                        'title'            => "JS Removes Age Limits for BSEC and IDRA Appointments",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Public Policy",
                        'title'            => "Government Cuts Office Hours to Save Energy",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Public Policy",
                        'title'            => "WASA Amendment Bill Gives Government Appointment Powers",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Senior Iranian Officer Says Fresh Conflict With US Likely",
                        'sub_title'        => "Iran’s latest proposal fails to calm regional tensions",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "International",
                        'title'            => "Israel Says Two Gaza Flotilla Activists Taken for Questioning",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "International",
                        'title'            => "Iran War Pushes Up Travel Costs and Airline Pressure",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "International",
                        'title'            => "Trump Says US Navy Acting Like Pirates Amid Iran Blockade",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "International",
                        'title'            => "Nato Seeks Details on US Troop Cut From Germany",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Trump Administration Accused of Defying Lower Court Rulings",
                        'sub_title'        => "Judicial tensions grow over immigration, spending and executive power",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Global Politics",
                        'title'            => "US Plans to Withdraw 5,000 Troops From Germany",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Global Politics",
                        'title'            => "May Day Protests Worldwide Demand Relief From Rising Costs",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Global Politics",
                        'title'            => "UK PM Eyes New Powers to Ban Some Pro-Palestinian Marches",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Global Politics",
                        'title'            => "Abortion Pill Makers Ask US Supreme Court to Restore Mail Access",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Dhaka and EU Seek Stronger Ties and Broader Cooperation",
                        'sub_title'        => "Bangladesh and EU review trade, investment and partnership agenda",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Diplomacy",
                        'title'            => "Bangladesh and India Move to Restore Full Visa Services",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Diplomacy",
                        'title'            => "Iran Sends New US Talks Proposal Through Pakistan",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Diplomacy",
                        'title'            => "Bangladesh FM Urges Global Action to Contain Energy Crisis",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Diplomacy",
                        'title'            => "Russian Ambassador Meets Jatiya Sangsad Speaker",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Fresh Middle East War Developments Include Lebanon Strikes",
                        'sub_title'        => "Israeli strikes in southern Lebanon kill three amid fragile truce",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Conflicts",
                        'title'            => "Russia Says Ukrainian Drone Attack Killed Two Teenagers",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Conflicts",
                        'title'            => "Two Gaza Flotilla Activists Questioned After Israeli Interception",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Conflicts",
                        'title'            => "Mali Jihadists Call for Unified Front and Begin Bamako Blockade",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Conflicts",
                        'title'            => "Renewed US-Iran Fighting Seen as Likely by Iranian Officer",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Iran War Raises Airline Costs and Fares Worldwide",
                        'sub_title'        => "Fuel prices and Hormuz disruption squeeze airline operations",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "World Economy",
                        'title'            => "UN Chief Warns Hormuz Closure Is Strangling Global Economy",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "World Economy",
                        'title'            => "WTO Talks Fail to Extend E-Commerce Duty Moratorium",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "World Economy",
                        'title'            => "Berkshire Hathaway Profit Rises as Investment Gains Improve",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "World Economy",
                        'title'            => "Global Markets Tread Water on Earnings and Jobs Outlook",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "UN Extends South Sudan Peacekeeping Mission But Shrinks It",
                        'sub_title'        => "Security Council renews UNMISS while reducing the troop ceiling",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Organizations",
                        'title'            => "Nato Reviews US Decision to Cut Germany Troop Presence",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Organizations",
                        'title'            => "WTO Faces Criticism After E-Commerce Moratorium Talks Fail",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Organizations",
                        'title'            => "UN Chief Raises Alarm Over Hormuz Impact on Global Economy",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Organizations",
                        'title'            => "IAEA Role Highlighted as Iran Defends Enrichment Supervision",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladesh Economy and Trade Regain Momentum After Policy Steps",
                        'sub_title'        => "Fuel supply, export financing and agro-industry support help recovery",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Business",
                        'title'            => "Haor Farmers Forced to Sell Wet Boro Paddy at Lower Prices",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Business",
                        'title'            => "Biman Signs Boeing Deal to Buy 14 New Aircraft",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Business",
                        'title'            => "Beef Prices Rise in Dhaka as Food Costs Increase",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Business",
                        'title'            => "Chattogram Port Records Highest Single-Day Container Handling",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "DSE Index Falls Despite Higher Trading Activity",
                        'sub_title'        => "Investors stay cautious as selling pressure hits listed shares",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Stock Market",
                        'title'            => "Dhaka Stocks Jump 161 Points After Iran Ceasefire News",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Stock Market",
                        'title'            => "DSE Bars Trading of Five Islamic Banks Before Merger",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Stock Market",
                        'title'            => "BSEC Explores Flexible IPO Proceeds Rules",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Stock Market",
                        'title'            => "Stocks Manage Modest Gain as Buyers Return",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "More Than Half of Local Banks Ineligible for Dividend Payouts",
                        'sub_title'        => "Rising bad loans and provisioning gaps weaken bank finances",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Banking",
                        'title'            => "Bangladesh Bank Waives Provisioning for Funds Stuck in Five Banks",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Banking",
                        'title'            => "Sammilito Islamic Bank Merger Faces Structural Questions",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Banking",
                        'title'            => "BB Revises Interest Rates on Long-Term Financing Facility",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Banking",
                        'title'            => "Bangladesh Bank Allows Staff Bonuses at Some Banks",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Walton Holds Global Distributor Meet 2026 in Nepal",
                        'sub_title'        => "Bangladeshi electronics brand gathers over 250 global partners",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Corporate",
                        'title'            => "Unique Hotel CEO Wins Who’s Who Bangladesh Award 2026",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Corporate",
                        'title'            => "Unilever Plans Small Price Hikes Amid Iran War Cost Pressure",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Corporate",
                        'title'            => "Electromart Wins Three Bangladesh Retail Awards",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Corporate",
                        'title'            => "Biman Boeing Purchase Signals Major Corporate Expansion",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "iFarmer Secures $1.5 Million From Symbiotics",
                        'sub_title'        => "International capital continues backing Bangladesh agritech infrastructure",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Startups",
                        'title'            => "Bangladesh Startups Face Funding Crunch as Boom Slows",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Startups",
                        'title'            => "Gold Kinen Recognised at Bangladesh Retail Awards 2026",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Startups",
                        'title'            => "SBAC Bank Transfers Funds to Bangladesh Startup Investment Company",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Startups",
                        'title'            => "Bangladesh EV Market Opens Space for Startup Innovation",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Trade",
                        'title'            => "Exports Unlikely to Recover Without Middle East Crisis Solution",
                        'sub_title'        => "Energy prices and supply concerns weigh on Bangladesh’s export outlook",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Trade",
                        'title'            => "Bangladesh Looks Beyond Hormuz for Fertiliser Imports",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Trade",
                        'title'            => "Low-Interest Pre-Shipment Credit Relaunched for Exporters",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Trade",
                        'title'            => "Rising Energy Costs Threaten Export Competitiveness",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Trade",
                        'title'            => "Finance Minister Promises Reforms to Ease Business and Expand Incentives",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Smart Classrooms Project Set to Modernize Secondary Education",
                        'sub_title'        => "Government moves to make classrooms more digital and interactive",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Technology",
                        'title'            => "Hour of AI Campaign Launched in Secondary Schools Nationwide",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Technology",
                        'title'            => "Digital Device and Innovation Expo Showcases Local Tech Ambitions",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Technology",
                        'title'            => "Civic Tech Innovation Expo Highlights Youth-Led Digital Governance",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Technology",
                        'title'            => "Broadband Expo Places Internet at Center of Smart Bangladesh Vision",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "AI",
                        'title'            => "Hour of AI Campaign Begins Across Secondary Schools",
                        'sub_title'        => "Students to receive basic exposure to AI, coding and programming",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "AI",
                        'title'            => "AI to Feature in Viva for Private Institution Head Recruitment",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "AI",
                        'title'            => "EWU Seminar Discusses AI and Cybersecurity Skills",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "AI",
                        'title'            => "Experts Warn Bangladesh Must Close AI Skills Gap",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "AI",
                        'title'            => "AI Automation Puts Workforce Skills in Focus",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Mobile Phone Prices Set to Fall After Import Duty Cut",
                        'sub_title'        => "NBR cuts customs duty on imported handsets to ease consumer costs",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Gadgets",
                        'title'            => "Digital Device Expo Opens Space for Smart Devices and Innovation",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Gadgets",
                        'title'            => "Government Legalizes Stock-Lot Phones Within BTRC Timeline",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Gadgets",
                        'title'            => "NEIR Rollout Pushes Mobile Market Toward Formal Regulation",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Gadgets",
                        'title'            => "Local Tech Products Gain Spotlight at Dhaka Innovation Expo",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "National Source Code Policy Draft Published by ICT Division",
                        'sub_title'        => "Public Money, Public Code policy targets transparency and reuse",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Software",
                        'title'            => "Rajshahi University Medical Centre Launches Automation Software",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Software",
                        'title'            => "ICT Ministerial Recommendations Emphasize Data Governance",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Software",
                        'title'            => "Government Email Software Tender Signals Service Upgrade",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Software",
                        'title'            => "Civic Tech Expo Promotes Software Solutions for Public Inclusion",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Broadband Seen as Main Driving Force for Smart Bangladesh",
                        'sub_title'        => "Expo highlights connectivity, AI use and digital public-service goals",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Internet",
                        'title'            => "Bangladesh Calls for Digital Push at UN Forum",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Internet",
                        'title'            => "Starlink Service Keeps Satellite Internet in Bangladesh Debate",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Internet",
                        'title'            => "BSCCL Internet Price Cut Expected to Reduce Connectivity Costs",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Internet",
                        'title'            => "Carnival Internet Expands Rural Broadband Marketplace",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "EWU Seminar Highlights AI and Cybersecurity Threat Readiness",
                        'sub_title'        => "Speakers urge students to build stronger technical foundations",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Cybersecurity",
                        'title'            => "Evilginx Pro Raises Alarm Over Two-Factor Authentication Safety",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Cybersecurity",
                        'title'            => "Cybersecurity Threats Grow More Dangerous in the Age of AI",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Cybersecurity",
                        'title'            => "Election Digital Preparedness Faces AI and Cybersecurity Questions",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Cybersecurity",
                        'title'            => "Public Software Policy Stresses Security and Reusability",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Nationwide Notun Kuri Sports Begins With Over 160,000 Registrations",
                        'sub_title'        => "Youth talent hunt starts across eight sporting disciplines",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Sports",
                        'title'            => "New Zealand Beat Bangladesh to Level T20I Series",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Sports",
                        'title'            => "Dhaka Premier League Returns With New Rules and Player Facilities",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Sports",
                        'title'            => "Bangladesh Championship League Final Round Starts Sunday",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Sports",
                        'title'            => "Sinner and Zverev Reach Madrid Open Final",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Jacobs’ Blitz Denies Bangladesh as T20I Series Ends Level",
                        'sub_title'        => "New Zealand chase revised target after Bangladesh batting collapse",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Cricket",
                        'title'            => "Tigresses Suffer T20I Whitewash After Narrow Sri Lanka Defeat",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Cricket",
                        'title'            => "DPL to Kick Off With Phone Ban and Integrity Measures",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Cricket",
                        'title'            => "CCDM Confirms Single-League Format for DPDCL Season",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Cricket",
                        'title'            => "Liton Says Lower-Order Collapse Is a Growing Concern",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladesh Drawn With India and Maldives in SAFF Women’s Championship",
                        'sub_title'        => "Defending champions placed in Group B for Goa tournament",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Football",
                        'title'            => "Kool-BSJA Media Cup Football Draw and Jerseys Unveiled",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Football",
                        'title'            => "Final Round of Bangladesh Championship League Begins",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Football",
                        'title'            => "City Club Thrash Chittagong Abahani as Saheed Hits Hat-Trick",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Football",
                        'title'            => "SAFF U-20 Winning Bangladesh Team Gets Reception Plan",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Sinner Beats Fils to Reach Madrid Open Final Against Zverev",
                        'sub_title'        => "World number one extends winning run before Masters final",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Tennis",
                        'title'            => "Rybakina Crashes Out as Sabalenka Reaches Madrid Quarter-Finals",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Tennis",
                        'title'            => "Kostyuk Wins First WTA 1000 Title in Madrid",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        'brief'            => "Marta Kostyuk claimed the biggest title of her career by defeating Mirra Andreeva in the Madrid Open women’s final.",
                        "body"             => "Marta Kostyuk won her first WTA 1000 title by defeating Mirra Andreeva in the Madrid Open women’s final. The Ukrainian player controlled key moments of the match and completed a breakthrough run on clay. The victory marked the biggest title of her career and lifted her standing among the top contenders title into the next phase of the clay season.",
                    ...
                    (object) [
                        "category_name"    => "Tennis",
                        'title'            => "Zarif Abrar Reaches Quarter-Finals at World Tennis Tour Junior Dhaka",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Tennis",
                        'title'            => "Bangladeshi Tennis Coaches Build Strong Reputation in China",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Notun Kuri Sports Inaugurated Across Bangladesh",
                        'sub_title'        => "Youth competition begins with live district-level opening events",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Local Sports",
                        'title'            => "Notun Kuri Sports-2026 Officially Opens in Rajshahi",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Local Sports",
                        'title'            => "BSJA Media Cup to Feature 32 Media Houses in Dhaka",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Local Sports",
                        'title'            => "Khelaghar and Chattogram City FC Win BCL Matches",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Local Sports",
                        'title'            => "City Club Register Big BCL Win With Saheed Hat-Trick",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Mohamed Salah to Miss Rest of Liverpool Season With Hamstring Injury",
                        'sub_title'        => "Egypt winger expected to recover before 2026 World Cup",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "International Sports",
                        'title'            => "Barcelona Beat Osasuna to Move Closer to LaLiga Title",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "International Sports",
                        'title'            => "FIFA Reopens Last-Minute Sales for 2026 World Cup Tickets",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "International Sports",
                        'title'            => "Bayern Rescue Late Draw Against Heidenheim",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "International Sports",
                        'title'            => "Iran Officials Seek FIFA Meeting Over World Cup Issues",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Dhallywood Finds Fresh Momentum as Cinema Halls Draw Crowds",
                        'sub_title'        => "Audience turnout signals renewed confidence in local cinema",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Entertainment",
                        'title'            => "Afran Nisho-Starrer Domm Continues Strong Run in Cineplexes",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Entertainment",
                        'title'            => "Filmmakers Prepare Crowded Eid Release Lineup",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Entertainment",
                        'title'            => "Warfaze Partners With Zippo for Collectible Music Editions",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Entertainment",
                        'title'            => "BTV Plans Special Band Music Show for Eid Viewers",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Domm Set for International Premiere After Domestic Success",
                        'sub_title'        => "True-story film gains overseas attention after strong local run",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Movies",
                        'title'            => "Dhallywood Comeback Raises Hope for Cinema Hall Business",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Movies",
                        'title'            => "Manusher Bagan Becomes First 2026 Film to Receive Certification",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Movies",
                        'title'            => "Top Dhallywood Stars Line Up for Eid 2026 Releases",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Movies",
                        'title'            => "Three Bangladeshi Films Enter Asia’s Top Cinema List",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Music",
                        'title'            => "Miles Set to Perform at BMBAA Unplugged Event",
                        'sub_title'        => "Legendary Bangla band joins exclusive music night in Dhaka",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Music",
                        'title'            => "Fuad Reimagines Prothom Bangladesh for New Generation",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Music",
                        'title'            => "Warfaze Marks Cultural Milestone With Zippo Collaboration",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Music",
                        'title'            => "Eid Celebrations Bring Wave of New Music Releases",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Music",
                        'title'            => "Bangladesh Releases First Fully AI-Generated Cinematic Music Video",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "BTV Launches New Magazine Show Abhinandan",
                        'sub_title'        => "Programme honours talent, dedication and inspiring journeys",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "TV Shows",
                        'title'            => "Duronto TV Rolls Out Pahela Baishakh Special Programmes",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "TV Shows",
                        'title'            => "Duronto TV Plans International Mother Language Day Specials",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "TV Shows",
                        'title'            => "BTV to Air Eid Band Show With Popular Bangladeshi Groups",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "TV Shows",
                        'title'            => "Behind the Fame Podcast Opens With Mehazabien Chowdhury",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Actor Shams Suman Dies at 61 in Dhaka",
                        'sub_title'        => "National Award-winning actor remembered for stage, TV and film work",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Celebrities",
                        'title'            => "Veteran Actor Ilias Javed Passes Away in Uttara",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "Celebrities",
                        'title'            => "Jaya Ahsan Mourns Rahul Arunoday Banerjee’s Death",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Celebrities",
                        'title'            => "Actor Tinu Karim Dies After Casting Vote in Barishal",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "Celebrities",
                        'title'            => "Artistes Turn Up at Polls and Share Voting Moments Online",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "OTT",
                        'title'            => "Saif Ali Khan Returns to Netflix With Kartavya",
                        'sub_title'        => "Crime drama expected to premiere on Netflix in mid-May",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "OTT",
                        'title'            => "HBO Max Launch Plan Includes Bangladesh and Asia Pacific Markets",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "OTT",
                        'title'            => "Omimangshito Finally Set for Release After Certification Dispute",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "OTT",
                        'title'            => "Toffee’s Concert Streaming Model Shows Demand for Digital Events",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "OTT",
                        'title'            => "Celebrity Podcasts Add New Digital Entertainment Format",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Health card plan aims to widen basic healthcare access",
                        'sub_title'        => "Government priority on marginalised patients",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Government moves to tighten animal feed safety",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Heart disease prevention gets renewed policy attention",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "New maternal hospital opens in Cox’s Bazar refugee camp",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "District proposals expose rural healthcare shortages",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Medical university expansion stalled by project delays",
                        'sub_title'        => "Postgraduate training faces infrastructure gap",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "New resident doctors urged to serve with compassion",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "BMU vice-chancellor stresses modern diagnostic labs",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Mobile cardiac units planned for village-level care",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Cervical cancer awareness highlighted as lifesaving tool",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Measles-rubella campaign expands nationwide from May",
                        'sub_title'        => "Emergency drive targets missed children",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Suspected measles deaths keep pressure on health system",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Rainfall raises concern over dengue transmission",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "DGHS records 14 fresh dengue cases overnight",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Vaccine procurement warning adds urgency to measles response",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Cumilla reports another child death with measles-like symptoms",
                        'sub_title'        => "District death count rises",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Rangpur child dies after measles-like illness",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "National suspected measles toll reaches alarming level",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Early dengue pattern keeps hospitals on alert",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Heart disease described as major public health challenge",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Experts urge nutrition to be placed at centre of health systems",
                        'sub_title'        => "Malnutrition weakens treatment outcomes",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Food insecurity warning raises nutrition concerns",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Food safety debate links affordability with nutrition quality",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Animal feed control tied to safer meat milk and eggs",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Malnutrition remains priority during National Nutrition Week",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Government launches programme to reduce adolescent suicide risk",
                        'sub_title'        => "Teachers and students to receive training",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladesh mental health crisis deepens amid treatment gaps",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Mental health rights protection needs stronger implementation",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "DSHE orders mental health programme in all schools and colleges",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Experts warn stigma keeps youth from mental healthcare",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Rohingya camp volunteer teachers receive formal certificates",
                        'sub_title'        => "Training aims to improve classroom learning",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Government to publish white paper on education sector",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Free uniforms shoes and bags to reach students from July",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "HSC and equivalent examinations scheduled to begin on July 2",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "UGC prepares policy for ethical AI use in higher education",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Primary students to get dress shoes and jute bags from July",
                        'sub_title'        => "Pilot support starts in selected schools",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Selected Dhaka schools begin blended classroom model",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Teacher absenteeism hurts primary education in Hatiya",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Religious teacher recruitment plan targets primary schools",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Free schooling age extension under government discussion",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Former DU VC joins Grameen University as senior adviser",
                        'sub_title'        => "New campus being built in Gazipur",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Education minister urges universities to protect intellectual property",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Gazipur Agricultural University leads agri universities in Asia ranking",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Modern labs and library opened at DU pharmacy faculty",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Dhaka Central University ordinance formally issued",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Nearly 28,000 absent on fifth day of SSC exams",
                        'sub_title'        => "Absence remains high in public examinations",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Over 32,000 absent from SSC English second paper test",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "More than 34,000 absent on third day of SSC exams",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Wrong question set leads to action against centre officials",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "HSC routine published for nine general education boards",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Sixteen DU students receive Tk 2.5 lakh in scholarships",
                        'sub_title'        => "Memorial trust funds support students",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Foundation awards scholarships to DU business students",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Primary scholarship examination begins under national schedule",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Malaysia considers more scholarships for Bangladeshi students",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Government considers doubling scholarship amounts",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "White paper planned on past education sector irregularities",
                        'sub_title'        => "Investigation scope may be wide",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "UGC drafts ethical AI policy for universities",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Education ministry weighs free schooling up to age 13",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Third language plan raises school curriculum debate",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "UGC drafting anti-plagiarism policy for higher education",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Shompa Kabir showcases Bangladeshi food on MasterChef USA",
                        'sub_title'        => "Halibut bhuna earns global attention",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Sylhet rainy season travel gains fresh appeal",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Sabina Khan brings Bangladeshi flavours to MasterChef UK",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Asad Sattar redefines youth culture through Arka",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Art galleries become meaningful dating spaces in Dhaka",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Teep returns as a bold urban fashion statement",
                        'sub_title'        => "Traditional mark gains modern styling",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Slow fashion gains ground among conscious shoppers",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladeshi designer Tanvir Mahidy debuts at London Fashion Week",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Spring saree trends favour florals and bold prints",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Panjabi and Kabuli sets shape Eid menswear",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Sylhet monsoon guide highlights Ratargul and Jaflong",
                        'sub_title'        => "Rain transforms popular nature spots",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Nepal trekking guide targets first-time Bangladeshi travellers",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Hajj flights set to carry Bangladeshi pilgrims",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Quick international getaways become popular from Dhaka",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Netrokona promoted as quiet nature escape",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Shompa Kabir wins MasterChef apron with halibut bhuna",
                        'sub_title'        => "Bangladeshi dish impresses global judges",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bhorta celebrated as Bangladesh’s humble comfort food",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Baishakh sweets keep family food memories alive",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Nayeem Ashraf returns to build culinary industry",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "High-protein iftar ideas use everyday Bangladeshi foods",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Art galleries become calmer dating spots for young couples",
                        'sub_title'        => "Culture helps start better conversations",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Money secrecy raises relationship red flag debate",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Love marriage and arranged marriage debate continues in Dhaka",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Marriage expenses reshape family decisions in Bangladesh",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Young generation questions pressure around marriage",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Ethnological museum in Chattogram faces declining visitors",
                        'sub_title'        => "Rare cultural collection needs revival",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Boishakhi Shobhajatra name chosen for New Year procession",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Dhaka amateur radio community keeps global links alive",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladeshi wedding culture changes under inflation pressure",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Rooftop radio story reflects Bangladesh’s hidden hobby culture",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Young Scientist Congress puts AI at centre of science agenda",
                        'sub_title'        => "Researchers showcase future-focused ideas",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "National AI institute plan gains fresh policy attention",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Science and technology fair begins in Gaibandha",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladesh Academy of Sciences hosts young researchers",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Officials call science vital for development and security",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Lalmonirhat aerospace university aims to produce astronauts",
                        'sub_title'        => "Aviation campus highlights space ambition",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladesh astronomy enthusiasts prepare for national round",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Eta Aquarid meteor shower draws attention from skywatchers",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladeshi students’ space settlement success inspires schools",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladesh’s Artemis Accords role keeps space cooperation in focus",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "BAU scientist develops chemical-free paddy protection device",
                        'sub_title'        => "Grain Guard targets storage losses",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "BLRI researches climate-resilient fodder crops",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "IRRI partnership pushes next-generation rice research",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Dhaka University urged to become research-oriented",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Pharma sector urged to strengthen innovation capacity",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Government promises proper recognition for innovators",
                        'sub_title'        => "IP services to be modernised",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Civic tech expo highlights youth-led digital solutions",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Student innovation signals future potential in Hathazari",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Solar power proposed as escape from energy trap",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladesh losing innovation race sparks fresh debate",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "AI Olympiad regional round draws young tech enthusiasts",
                        'sub_title'        => "Dhaka event shows AI education momentum",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Kaggle workshop trains future AI leaders",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "UGC prepares ethical AI policy for higher education",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladesh urges stronger data systems at UN forum",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Renewable transition research warns energy crisis may persist",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Grain Guard discovery offers safer paddy storage option",
                        'sub_title'        => "Ultrasonic device avoids harmful chemicals",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Climate-resilient fodder research points to safer livestock future",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Next-generation rice work targets climate pressure",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Astronomy olympiad reveals strong student interest in space science",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Science fairs uncover practical student innovations",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "April rainfall rises far above normal across Bangladesh",
                        'sub_title'        => "BMD warns of heatwaves and low pressure",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Hill cutting and forest land sales continue in Cox’s Bazar",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Barishal water plant returns to reduce groundwater pressure",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Police move to form special unit for environmental crimes",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Clean and green Dhaka plan puts pollution control in focus",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Bangladesh faces new climate reality as heatwaves intensify",
                        'sub_title'        => "Longer hotter spells worry experts",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Rising heat may sharply increase deaths by 2050",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "BMD warns low pressure systems may form in Bay",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Children remain highly exposed to climate shocks",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Heatwave forecasts keep public health services on alert",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Noise Awareness Day puts invisible pollution in spotlight",
                        'sub_title'        => "Mobile courts and rallies held nationwide",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Dhaka air again ranks among world’s worst",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Industrial waste threatens rivers in Narsingdi",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "ETP monitoring planned for industries near Dhaka rivers",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Mobile courts target black smoke and brick kiln pollution",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Dead elephant found mutilated in Rangamati forest",
                        'sub_title'        => "Experts allege poor carcass protection",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Rare freshwater crocodile caught safely in Padma",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Old wild elephant dies after injuries in Rangamati",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Endangered Bengal Slow Loris rescued in Habiganj",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Sundarbans tigers face uncertain future despite conservation work",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Lightning strikes kill ten people across five districts",
                        'sub_title'        => "Storms also kill dozens of cattle",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Khowai embankment breach floods haor croplands",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Wall collapse during heavy rain kills woman in Chattogram",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Rain and landslides strand hundreds in Moulvibazar",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "BMD forecasts heavy rain and thunderstorm risk nationwide",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "SMEs could cut over 14 million tons of carbon yearly",
                        'sub_title'        => "Study highlights solar and factory efficiency",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Solar irrigation seen as path out of energy pressure",
                        'sub_title'        => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Rupatali water plant supports sustainable urban supply",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "Dhaka green plan includes trees electric buses and ETPs",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "RMG green transition debate urges buyer responsibility",
                        'sub_title'        => "",
                        'content_shoulder' => "",
            ...
            (object) [
                ...
                'newses'        => collect([
                    (object) [
                        ...
                        'title'            => "ডিসি সম্মেলনে মাঠ প্রশাসনকে জনবান্ধব হওয়ার নির্দেশ",
                        'sub_title'        => "প্রশাসনে স্বচ্ছতা ও জবাবদিহি বাড়ানোর ওপর জোর",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জাতীয়",
                        'title'            => "ঋণের বোঝা নিয়েই কাজ শুরু করেছে সরকার",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "জাতীয়",
                        'title'            => "এআই ও ডিজিটাল দক্ষতায় উন্নতির তাগিদ প্রধানমন্ত্রীর",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জাতীয়",
                        'title'            => "গণমাধ্যমের স্বাধীনতা ও আস্থা পুনর্গঠনে আলোচনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জাতীয়",
                        'title'            => "ডিসি সম্মেলনে ৪৯৮ প্রস্তাব নিয়ে আলোচনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "সংস্কার বাস্তবায়নে সরকারকে চাপ দেওয়ার আহ্বান এনসিপির",
                        'sub_title'        => "জুলাই সনদ বাস্তবায়ন না হলে কর্তৃত্ববাদ ফেরার আশঙ্কা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "রাজনীতি",
                        'title'            => "ক্ষমতার বাহানায় সংস্কার না করার অভিযোগ আখতারের",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "রাজনীতি",
                        'title'            => "এনসিপি ও এবি পার্টি একীভূত হওয়া নিয়ে আলোচনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "রাজনীতি",
                        'title'            => "ছাত্রদলের একযোগে ২৯ কমিটি অনুমোদন",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "রাজনীতি",
                        'title'            => "দলিত ও হরিজনদের নিয়ে এনসিপি সমর্থিত সংগঠনের আত্মপ্রকাশ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সরকার",
                        'title'            => "রাজনৈতিক পরিচয়ে বৈষম্য না করার নির্দেশ",
                        'sub_title'        => "সরকারি সেবা সবার জন্য সমান রাখতে মাঠ প্রশাসনকে বার্তা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সরকার",
                        'title'            => "মোবাইল কোর্ট জোরদারে জেলা প্রশাসকদের নির্দেশ",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "সরকার",
                        'title'            => "ডিসি সম্মেলনে সরকারের নীতি ও উন্নয়ন কর্মসূচি পর্যালোচনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সরকার",
                        'title'            => "প্রশাসনে সততা, মেধা ও দক্ষতাকে নীতি বললেন প্রধানমন্ত্রী",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সরকার",
                        'title'            => "গণপরিবহনে শৃঙ্খলা আনতে নতুন পরিকল্পনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "মোহাম্মদপুরের অপরাধ দমনে রায়েরবাজারে নতুন থানা হবে",
                        'sub_title'        => "ডিএমপি বলছে চাঁদাবাজ, অস্ত্রধারী ও মাদকচক্রের বিরুদ্ধে অভিযান চলছে",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আইন ও শৃঙ্খলা",
                        'title'            => "৩০ লাখ টাকার কাপড় লুটের ঘটনায় পাঁচজন গ্রেপ্তার",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "আইন ও শৃঙ্খলা",
                        'title'            => "নৌ পুলিশের ওপর গুলির মামলার আসামি ঢাকায় গ্রেপ্তার",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আইন ও শৃঙ্খলা",
                        'title'            => "তেজগাঁও বিভাগে অভিযানে ৫১ জন গ্রেপ্তার",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আইন ও শৃঙ্খলা",
                        'title'            => "ঘুষের অভিযোগের পর মিরপুর থানার ওসি প্রত্যাহার",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "সংরক্ষিত নারী আসনে নুসরাত তাবাসসুমের মনোনয়ন বৈধ দাবি",
                        'sub_title'        => "নির্ধারিত সময়ের পরে জমা দেওয়া মনোনয়ন নিয়ে আইনি জটিলতা ছিল",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "নির্বাচন",
                        'title'            => "গণভোটের রায় মানার আহ্বান ১১ দলীয় নেতাদের",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "নির্বাচন",
                        'title'            => "এনসিপির আসন হিসাব ঘিরে সংরক্ষিত নারী আসনের আলোচনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "নির্বাচন",
                        'title'            => "স্থানীয় সরকার অধ্যাদেশ নিয়ে নির্বাচিত প্রতিনিধিদের অপসারণ বিতর্ক",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "নির্বাচন",
                        'title'            => "জোট রাজনীতির পরে দলীয় পুনর্গঠনে নজর নতুন দলগুলোর",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "বাজেট অর্থ ১৫ এপ্রিলের মধ্যে ছাড়ের প্রস্তাব ডিসিদের",
                        'sub_title'        => "ডিসি সম্মেলনে উন্নয়ন প্রকল্প বাস্তবায়ন দ্রুত করার আলোচনা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জননীতি",
                        'title'            => "ঢাকার গণপরিবহনে পিংক বাস ও মনোরেলের পরিকল্পনা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "জননীতি",
                        'title'            => "খাদ্যে ভেজাল ও বাল্যবিবাহে কঠোর হওয়ার নির্দেশ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জননীতি",
                        'title'            => "প্রতিবন্ধী শিক্ষার্থীদের শিক্ষা অবৈতনিক করার প্রস্তাব",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জননীতি",
                        'title'            => "পুলিশ সপ্তাহে ১০৭ সদস্যকে পদক দেওয়ার প্রস্তুতি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "ইসরায়েলি আদালতে তোলা হচ্ছে সুমুদ ফ্লোটিলার দুই অ্যাক্টিভিস্টকে",
                        'sub_title'        => "গাজাগামী ত্রাণবহর আটক ঘিরে নতুন আন্তর্জাতিক চাপ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক",
                        'title'            => "ইরান নিয়ে ট্রাম্পের সামনে দুটি পথ, দাবি আইআরজিসির",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক",
                        'title'            => "গাজার ধ্বংসস্তূপের নিচে এখনও আট হাজার মরদেহ থাকার আশঙ্কা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক",
                        'title'            => "ইরানের ১৪ দফা শান্তি প্রস্তাব পর্যালোচনায় যুক্তরাষ্ট্র",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক",
                        'title'            => "লেবাননে ইসরায়েলি হামলায় ২৪ ঘণ্টায় নিহত ৪১",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "মার্কিন সেনা প্রত্যাহার নিয়ে জার্মানি ও ন্যাটোর উদ্বেগ",
                        'sub_title'        => "ইউরোপের নিরাপত্তা ব্যয় বাড়ানোর চাপ আরও স্পষ্ট",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ব রাজনীতি",
                        'title'            => "তাইওয়ানের প্রেসিডেন্টকে ‘ইঁদুর’ বলল চীন",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ব রাজনীতি",
                        'title'            => "যুক্তরাষ্ট্র থেকে আরও যুদ্ধবিমান কিনবে ইসরায়েল",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ব রাজনীতি",
                        'title'            => "পোস্টাল ব্যালটে কারসাজির অভিযোগে নির্বাচন কমিশনে তৃণমূল",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ব রাজনীতি",
                        'title'            => "চীনা শোধনাগারে মার্কিন নিষেধাজ্ঞা অমান্যের নির্দেশ বেইজিংয়ের",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "পূর্ণাঙ্গ ভিসা চালুর পথে ঢাকা-দিল্লি সম্পর্ক",
                        'sub_title'        => "টানাপোড়েন কাটিয়ে ভিসা কার্যক্রম স্বাভাবিক করার উদ্যোগ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "কূটনীতি",
                        'title'            => "ইরানের জন্য সীমান্ত পথ খুলে দিলো পাকিস্তান",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "কূটনীতি",
                        'title'            => "ইরানের শান্তি প্রস্তাবে পাকিস্তানের মধ্যস্থতার ইঙ্গিত",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "কূটনীতি",
                        'title'            => "জার্মানি থেকে সেনা প্রত্যাহার ইস্যুতে ন্যাটোর সঙ্গে আলোচনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "কূটনীতি",
                        'title'            => "ইসরায়েলের কর্মকাণ্ডের নিন্দা জানালো ফ্রান্স",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সংঘাত",
                        'title'            => "লেবাননে ইসরায়েলি হামলায় যুদ্ধবিরতি প্রশ্নের মুখে",
                        'sub_title'        => "দক্ষিণ লেবাননে প্রাণহানি বাড়ায় আঞ্চলিক সংঘাতের ঝুঁকি",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সংঘাত",
                        'title'            => "গাজার ধ্বংসস্তূপ সরাতে বছরের পর বছর লাগার আশঙ্কা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "সংঘাত",
                        'title'            => "যুক্তরাষ্ট্রের সঙ্গে ফের যুদ্ধের আশঙ্কা জানালো ইরান",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সংঘাত",
                        'title'            => "ইয়েমেন উপকূলে তেলবাহী জাহাজ ছিনতাইয়ের খবর",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সংঘাত",
                        'title'            => "গাজাগামী ত্রাণবহর আটক ঘিরে ইসরায়েলে আদালত প্রক্রিয়া",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "চীনা শোধনাগারে মার্কিন নিষেধাজ্ঞা অমান্যের নির্দেশ",
                        'sub_title'        => "ইরানি তেল বাণিজ্য ঘিরে ওয়াশিংটন-বেইজিং অর্থনৈতিক টানাপোড়েন",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ব অর্থনীতি",
                        'title'            => "স্পিরিট এয়ারলাইন্স বন্ধে জ্বালানি বাজারের চাপ সামনে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ব অর্থনীতি",
                        'title'            => "চার দেশে ৮৬০ কোটি ডলারের অস্ত্র বিক্রির অনুমোদন যুক্তরাষ্ট্রের",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ব অর্থনীতি",
                        'title'            => "পাকিস্তানের স্থলপথে ইরানের বাণিজ্য নতুন স্বস্তি পেল",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ব অর্থনীতি",
                        'title'            => "ইসরায়েলের যুদ্ধবিমান কেনা প্রতিরক্ষা বাজারে বড় লেনদেন",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "গাজা ধ্বংসস্তূপ নিয়ে জাতিসংঘ কর্মকর্তার সতর্কতা",
                        'sub_title'        => "ধ্বংসাবশেষের নিচে মরদেহ ও পুনর্গঠনের দীর্ঘ সংকট",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক সংস্থা",
                        'title'            => "ন্যাটো বলছে ইউরোপকে নিরাপত্তার দায় বেশি নিতে হবে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক সংস্থা",
                        'title'            => "জাতিসংঘ অনুমোদনহীন নিষেধাজ্ঞার বিরোধিতা করল চীন",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক সংস্থা",
                        'title'            => "ইউরোপীয় নিরাপত্তায় জোটভিত্তিক সমন্বয়ের তাগিদ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক সংস্থা",
                        'title'            => "মানবিক ত্রাণবহর আটক নিয়ে আন্তর্জাতিক সংগঠনগুলোর নজর",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "দেশে লিড সনদ পাওয়া পোশাক কারখানা এখন ২৮৪টি",
                        'sub_title'        => "সবুজ শিল্পায়নে নতুন মাইলফলক ছুঁল তৈরি পোশাক খাত",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ব্যবসা",
                        'title'            => "বৃষ্টির প্রভাবে রাজধানীর বাজারে সবজির দাম বেড়েছে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "ব্যবসা",
                        'title'            => "মেহেরপুরে ৫৫ কোটি টাকার লিচু বাণিজ্যের সম্ভাবনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ব্যবসা",
                        'title'            => "নতুন বাজেটে করের বাড়তি চাপ নিয়ে ব্যবসায় উদ্বেগ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ব্যবসা",
                        'title'            => "বিদেশি ঋণ পরিশোধে চাপ বাড়ছে অর্থনীতিতে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "তালিকাভুক্ত সাত ব্যাংকের মুনাফা ও লভ্যাংশ ঘোষণা",
                        'sub_title'        => "সাউথইস্ট, যমুনা ও ব্যাংক এশিয়ার মুনাফায় বড় প্রবৃদ্ধি",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "শেয়ার বাজার",
                        'title'            => "ইসলামী ব্যাংক ‘এ’ থেকে ‘জেড’ ক্যাটাগরিতে নেমেছে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "শেয়ার বাজার",
                        'title'            => "পুঁজিবাজারের অর্থায়ন মোট স্থায়ী মূলধনের মাত্র ৬ শতাংশ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "শেয়ার বাজার",
                        'title'            => "রেকিট বেনকিজার প্রতিশেয়ারে ১৭৩ টাকা লভ্যাংশ দেবে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "শেয়ার বাজার",
                        'title'            => "ডিএসইতে সূচক ইতিবাচক, লেনদেনে সতর্ক বিনিয়োগকারী",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "বন্ধ কারখানা চালু করতে বিশেষ তহবিল আনছে বাংলাদেশ ব্যাংক",
                        'sub_title'        => "চলতি মূলধন সহায়তায় উৎপাদন ও কর্মসংস্থান ফেরানোর উদ্যোগ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ব্যাংকিং",
                        'title'            => "২০২৫ সালে কয়েকটি ব্যাংকের মুনাফায় বড় উল্লম্ফন",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "ব্যাংকিং",
                        'title'            => "সিটি ব্যাংকের প্রথম প্রান্তিকে নিট মুনাফা বেড়েছে ১৬২ শতাংশ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ব্যাংকিং",
                        'title'            => "সম্মিলিত ইসলামী ব্যাংক উদ্যোগ অনিশ্চয়তায়",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ব্যাংকিং",
                        'title'            => "ডলারের দাম নিয়ন্ত্রণে ফরওয়ার্ড বুকিংয়ে কড়াকড়ি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "বিএটিবির ঘোষিত ৩০ শতাংশ নগদ লভ্যাংশ অনুমোদন",
                        'sub_title'        => "অনলাইন এজিএমে শেয়ারধারীদের সম্মতি পেল কোম্পানি",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "কর্পোরেট",
                        'title'            => "৯ মাসে ৬৪৩ কোটি টাকা মুনাফা করেছে ওয়ালটন",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "কর্পোরেট",
                        'title'            => "যুক্তরাষ্ট্রের ব্যবসাপ্রতিষ্ঠান বাংলাদেশের উন্নয়ন প্রকল্পে আগ্রহী",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "কর্পোরেট",
                        'title'            => "কর না কমালে বিনিয়োগে গতি আসবে না, ব্যবসায়ীদের মত",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "কর্পোরেট",
                        'title'            => "পোশাক খাতে বৈশ্বিক সংকট ও বাণিজ্যনীতির চাপ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "৩৯ ব্যাংকের ৬০০ কোটি টাকায় স্টার্টআপ বিনিয়োগ কোম্পানি",
                        'sub_title'        => "তরুণ উদ্যোক্তাদের পুঁজি ও পরামর্শ দিতে বিএসআইসির যাত্রা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্টার্টআপ",
                        'title'            => "প্রাইম ব্যাংক স্টার্টআপে সর্বোচ্চ ৮ কোটি টাকা ঋণ দেবে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "স্টার্টআপ",
                        'title'            => "স্টার্টআপ খাতকে কাঠামোবদ্ধ করতে স্কেলআপ প্রোগ্রাম",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্টার্টআপ",
                        'title'            => "স্টার্টআপ বাংলাদেশ ও লাইটক্যাসলের কৌশলগত জোট",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্টার্টআপ",
                        'title'            => "অনলাইন গ্রোসারি স্টার্টআপগুলোর টিকে থাকা কঠিন হচ্ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "দোকানপাট রাত ৯টা পর্যন্ত খোলা রাখার দাবি দোকানমালিকদের",
                        'sub_title'        => "ঈদ বাজারে বিক্রি বাড়াতে সময় বাড়ানোর অনুরোধ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বাণিজ্য",
                        'title'            => "ঢাকা আন্তর্জাতিক বাণিজ্য মেলায় বিক্রি ৩৯৩ কোটি টাকা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "বাণিজ্য",
                        'title'            => "বাণিজ্য ঘাটতি বেড়ে ১৬.৯১ বিলিয়ন ডলারে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বাণিজ্য",
                        'title'            => "দাম বাড়তেই বাজারে ফিরেছে সয়াবিন তেল",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বাণিজ্য",
                        'title'            => "আদার বাজারে অস্থিরতা, দুই সপ্তাহে কেজিতে বেড়েছে ২০ টাকা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "জেমিনি চ্যাটবটে সরাসরি ফাইল তৈরির সুবিধা যুক্ত",
                        'sub_title'        => "পিডিএফ, ওয়ার্ড ও এক্সেল ফাইল বানানো যাবে চ্যাট থেকেই",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "প্রযুক্তি",
                        'title'            => "ঢাকায় অনুষ্ঠিত হলো বাংলাদেশ এআই অলিম্পিয়াডের আঞ্চলিক পর্ব",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "প্রযুক্তি",
                        'title'            => "ঢাকায় বিওয়াইডি বাংলাদেশের এক্সক্লুসিভ শোরুম চালু",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "প্রযুক্তি",
                        'title'            => "অস্কারে এআই দিয়ে তৈরি অভিনেতা ও চিত্রনাট্য অযোগ্য ঘোষণা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "প্রযুক্তি",
                        'title'            => "রেডিটের সার্চ ইঞ্জিন ব্যবহারকারী বেড়েছে ৩০ শতাংশ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "এআই",
                        'title'            => "বাংলাদেশ এআই অলিম্পিয়াডের জাতীয় পর্ব হবে ১৬ মে",
                        'sub_title'        => "আঞ্চলিক পর্ব শেষে ঢাকায় চূড়ান্ত প্রতিযোগিতা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "এআই",
                        'title'            => "বাংলায় বিনামূল্যে এআই শেখার কোর্স চালু",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "এআই",
                        'title'            => "চ্যাটজিপিটি ইমেজেস ২.০ বাস্তবসম্মত ছবি তৈরিতে উন্নতি এনেছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "এআই",
                        'title'            => "এআই বদলে দিচ্ছে আট ঘণ্টার কাজের হিসাব",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "এআই",
                        'title'            => "ক্রোম ব্রাউজারের এআই মোডে স্প্লিট-স্ক্রিন সুবিধা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "বিওয়াইডি আনছে প্লাগ-ইন হাইব্রিড সেডান",
                        'sub_title'        => "জ্বালানি ছাড়াই ৮০ কিলোমিটার চলার দাবি",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "গ্যাজেট",
                        'title'            => "টিম কুকের বিদায়বেলায় আইফোনের চাহিদায় নতুন রেকর্ড",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "গ্যাজেট",
                        'title'            => "বাংলাদেশে আইফোন ১৬ প্রো ম্যাক্সের চাহিদা বেশি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "গ্যাজেট",
                        'title'            => "টেকনোর নতুন স্মার্টফোন সিরিজ বাংলাদেশের বাজারে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "গ্যাজেট",
                        'title'            => "মেমোরি চিপ সংকটে স্মার্টফোনের দাম বাড়ার আশঙ্কা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "হোয়াটসঅ্যাপে নতুন স্পয়লার ফিচার আসছে",
                        'sub_title'        => "ট্যাপ না করলে লুকানো বার্তা দেখা যাবে না",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সফটওয়্যার",
                        'title'            => "আইওএস ২৭-এ আসছে এআইনির্ভর ফটো এডিটিং টুল",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "সফটওয়্যার",
                        'title'            => "ইনস্টাগ্রামে অন্যের ছবি বা পোস্ট শেয়ারে কড়াকড়ি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সফটওয়্যার",
                        'title'            => "ইউটিউবে ব্যবহারকারীদের জন্য নতুন আকর্ষণীয় ফিচার",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সফটওয়্যার",
                        'title'            => "হারানো এয়ারপড খুঁজে দিতে বিশেষ অ্যাপের সুবিধা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "জুলাই অভ্যুত্থানে সরকারের সিদ্ধান্তে ইন্টারনেট সেবা বন্ধ হয়েছিল",
                        'sub_title'        => "জবানবন্দিতে ব্যান্ডউইথ সরবরাহ বন্ধের তথ্য উঠে এসেছে",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ইন্টারনেট",
                        'title'            => "রেডিট সার্চে এআই সুবিধা যোগে ব্যবহারকারী বাড়ছে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "ইন্টারনেট",
                        'title'            => "এক্সের কমিউনিটিজ ফিচার বন্ধ হচ্ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ইন্টারনেট",
                        'title'            => "মোবাইল ডাটার দাম দেড় বছরে ৫০ শতাংশ পর্যন্ত বেড়েছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ইন্টারনেট",
                        'title'            => "এনইআইআর পরীক্ষায় সাময়িকভাবে মোবাইল সংযোগ বন্ধ হতে পারে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "সাইবার নিরাপত্তা বিল ২০২৬ সংসদে পাস",
                        'sub_title'        => "নতুন আইনি কাঠামোর পথে ডিজিটাল নিরাপত্তা খাত",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সাইবার নিরাপত্তা",
                        'title'            => "ব্রিটেনের ৪০ শতাংশ প্রতিষ্ঠানেই এক বছরে সাইবার হামলা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "সাইবার নিরাপত্তা",
                        'title'            => "টিকটক ক্লোন অ্যাপ থেকে ব্যাংক তথ্য চুরির সতর্কতা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সাইবার নিরাপত্তা",
                        'title'            => "৪০ শতাংশ অ্যান্ড্রয়েড ফোন ঝুঁকিতে, সতর্ক করল গুগল",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সাইবার নিরাপত্তা",
                        'title'            => "হাইব্রিড কর্মপরিবেশে নিরাপত্তা জোরদারে সফোসের সমাধান",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "ক্রীড়া কূটনীতিতে জোর দিচ্ছে সরকার",
                        'sub_title'        => "তৃণমূল থেকে প্রতিভা তুলে এনে বিশ্বমঞ্চে বাংলাদেশকে এগিয়ে নেওয়ার লক্ষ্য",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "খেলাধুলা",
                        'title'            => "চীন বিশ্বকাপে যাচ্ছেন বাংলাদেশের ১৩ আর্চার",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "খেলাধুলা",
                        'title'            => "সন্তান রেখে বিশ্বকাপে যাচ্ছেন আর্চার নাসরিন",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "খেলাধুলা",
                        'title'            => "আজ টিভিতে পিএসএল ফাইনালসহ ব্যস্ত খেলার দিন",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "খেলাধুলা",
                        'title'            => "এশিয়া কাপ আর্চারিতে সাফল্য পাওয়া আর্চারদের পুরস্কার",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "হারের পর ব্যাটিং নিয়ে লিটনের আক্ষেপ",
                        'sub_title'        => "নিউজিল্যান্ডের বিপক্ষে সিরিজ নির্ধারণী ম্যাচে বড় সংগ্রহ গড়তে পারেনি বাংলাদেশ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ক্রিকেট",
                        'title'            => "শেষ ম্যাচ জিতে সিরিজে সমতা ফেরাল নিউজিল্যান্ড",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "ক্রিকেট",
                        'title'            => "বাংলাদেশ নারী দলকে হোয়াইটওয়াশ করেছে শ্রীলঙ্কা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ক্রিকেট",
                        'title'            => "ওয়ানডে র‌্যাঙ্কিংয়ে বাংলাদেশের তিন পেসারের বড় লাফ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ক্রিকেট",
                        'title'            => "পিএসএলের ফাইনালে খেলার অনুমতি পেলেন নাহিদ রানা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ফুটবল",
                        'title'            => "স্বপ্ন এখনও বেঁচে আছে, বললেন আর্সেনাল কোচ",
                        'sub_title'        => "ফুলহামকে হারিয়ে প্রিমিয়ার লিগের শিরোপা দৌড়ে নিজেদের আশা ধরে রেখেছে আর্সেনাল",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ফুটবল",
                        'title'            => "৩ গোলে এগিয়ে থেকেও হারল মেসির ইন্টার মায়ামি",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "ফুটবল",
                        'title'            => "লা লিগা শিরোপার আরও কাছে বার্সেলোনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ফুটবল",
                        'title'            => "মামুনুলের বিদায়ী ম্যাচ জয়ে রাঙাল ফর্টিস",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ফুটবল",
                        'title'            => "বিএসজেএ মিডিয়া কাপ ফুটবলে ৩২ সংবাদমাধ্যম",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "টেনিস",
                        'title'            => "ফ্রেঞ্চ ওপেনে খেলছেন না কার্লোস আলকারেজ",
                        'sub_title'        => "কব্জির চোটে বর্তমান চ্যাম্পিয়নের রোলাঁ গারো মিশন শেষ হওয়ার আগেই থেমে গেল",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "টেনিস",
                        'title'            => "লরিয়াস বর্ষসেরা আলকারেজ ও সাবালেঙ্কা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "টেনিস",
                        'title'            => "টেবিল টেনিসে খই খইদের জন্য জাপানের কোচ ঢাকায়",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "টেনিস",
                        'title'            => "আইটিএফ এশিয়া অনূর্ধ্ব-14 টেনিসে সেমিফাইনালে থামল বাংলাদেশ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        'brief'            => "কম্বোডিয়ায় আইটিএফ এশিয়া অনূর্ধ্ব-14 ডেভেলপমেন্ট টেনিসে বাংলাদেশের বালিকা দ্বৈত জুটি সেমিফাইনালে হেরে বিদায় নিয়েছে।",
                        "body"             => "আইটিএফ এশিয়া অনূর্ধ্ব-14 ডেভেলপমেন্ট চ্যাম্পিয়নশিপস টেনিসে বাংলাদেশের বালিকা দ্বৈত জুটি সেমিফাইনাল থেকে বিদায় নিয়েছে। কম্বোডিয়ায় অনুষ্ঠিত প্রতিযোগিতায় বাংলাদেশের মাসতুরা আফরিন ও তাঁর সঙ্গী সিঙ্গাপুরের বিপক্ষে লড়াই করলেও শেষ পর্যন্ত জিততে পারেননি। বয়সভিত্তিক আন্তর্জাতিক প্রতিযোগিতায় এমন অভিজ্ঞতা তরুণ খেলোয়াড়দের জন্য গুরুত্বপূর্ণ। ম্যাচের চাপ, কোর্টের গতি ও ভিন্ন প্রতিপক্ষের কৌশল শেখার সুযোগ ভবিষ্যৎ উন্নতিতে কাজে লাগবে।",
                        'seo_keywords'     => "আইটিএফ টেনিস, অনূর্ধ্ব-14, বাংলাদেশ টেনিস, সেমিফাইনাল",
                        'published_at'     => "2026-02-05 17:20:00",
                    ],

                    (object) [
                        "category_name"    => "টেনিস",
                        'title'            => "অস্ট্রেলিয়ান ওপেনে ইতিহাস গড়েছিলেন আলকারেজ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "মিডিয়া কাপ ফুটবলে সংবাদমাধ্যমগুলোর উৎসব শুরু",
                        'sub_title'        => "বাফুফে টার্ফে ৩২ দলের অংশগ্রহণে সাংবাদিকদের ফুটবল আয়োজন",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্থানীয় খেলা",
                        'title'            => "মামুনুলের বিদায়ে আবেগঘন ঘরোয়া ফুটবল",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "স্থানীয় খেলা",
                        'title'            => "নারী হকির সাফল্যে স্থানীয় খেলাধুলায় নতুন আলো",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্থানীয় খেলা",
                        'title'            => "দেশীয় আর্চারদের পুরস্কার স্থানীয় প্রতিভাদের অনুপ্রেরণা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্থানীয় খেলা",
                        'title'            => "তৃণমূল থেকে খেলোয়াড় বাছাইয়ে গুরুত্ব বাড়ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "অরল্যান্ডোর বিপক্ষে হার মেনে নিতে পারছেন না মেসি",
                        'sub_title'        => "৩ গোলে এগিয়েও হারের পর ইন্টার মায়ামির ড্রেসিংরুমে কঠোর বার্তা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক খেলা",
                        'title'            => "বার্সেলোনার চোখ এখন লা লিগা উৎসবে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক খেলা",
                        'title'            => "শিরোপার কাছে এসে পয়েন্ট হারাল পিএসজি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক খেলা",
                        'title'            => "পিএসজি ম্যাচের আগে বায়ার্ন মিউনিখের হোঁচট",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "আন্তর্জাতিক খেলা",
                        'title'            => "ফিফা বলছে যুক্তরাষ্ট্রে বিশ্বকাপ খেলবে ইরান",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "ইউটিউব চ্যানেল খুললেন জয়া আহসান",
                        'sub_title'        => "ভক্তদের সঙ্গে সরাসরি যোগাযোগের নতুন প্ল্যাটফর্ম",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিনোদন",
                        'title'            => "ছেলেকে ড্রাম শেখাচ্ছেন জেমস, ভিডিও ভাইরাল",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিনোদন",
                        'title'            => "‘কন্ট্র্যাক্ট ম্যারেজ’ সিনেমা দিয়ে ফিরছেন মৌসুমী",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "বিনোদন",
                        'title'            => "‘এটা আমাদেরই গল্প’ শেষ হচ্ছে ৮ মে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিনোদন",
                        'title'            => "চলচ্চিত্র পরিচালনায় আসছেন জিয়াউল হক পলাশ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "দেশে প্রথমবার ‘মাইগ্রেশন ফিল্ম ফেস্ট’, চলচ্চিত্র জমা নেওয়া শুরু",
                        'sub_title'        => "অভিবাসনের বাস্তব গল্প নিয়ে নতুন চলচ্চিত্র আয়োজন",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সিনেমা",
                        'title'            => "জার্মানিতে পুরস্কার জিতল বাংলাদেশের ‘আলী’",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সিনেমা",
                        'title'            => "‘বনলতা এক্সপ্রেস’ উত্তর আমেরিকায় ৪ লাখ ডলারের ক্লাবে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "সিনেমা",
                        'title'            => "ভিয়েনা চলচ্চিত্র উৎসবে বাংলাদেশি চলচ্চিত্র ‘দেলুপি’",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সিনেমা",
                        'title'            => "মস্কো চলচ্চিত্র উৎসবে বাংলাদেশের দুই সিনেমা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        ...
                        'published_at'     => "2026-04-13 02:00",
                    ],

                    (object) [
                        "category_name"    => "সংগীত",
                        'title'            => "প্রকাশিত হলো আলিফ আলাউদ্দীনের চতুর্থ অ্যালবাম",
                        'sub_title'        => "ছয়টি গান নিয়ে নতুন একক অ্যালবাম",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সংগীত",
                        'title'            => "রুনা লায়লা ও বাপ্পা মজুমদারের প্রথম বাংলা গজল",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        ...
                        'published_at'     => "2026-04-25 14:58",
                    ],

                    (object) [
                        "category_name"    => "সংগীত",
                        'title'            => "শাকিব খানের পারফর্মে প্রকাশ পেল ‘জয়ধ্বনি’",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "সংগীত",
                        'title'            => "১৮ বছর পর নতুন রূপে ‘বাজেরে বাজে ঢোল আর ঢাক’",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সংগীত",
                        'title'            => "বাদশাহ–নোরা ফাতেহির গানে বাংলাদেশের তাশফী",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        ...
                        'published_at'     => "2026-04-06 18:15",
                    ],

                    (object) [
                        "category_name"    => "টিভি শো",
                        'title'            => "‘এটা আমাদেরই গল্প’র শুটিং শেষ",
                        'sub_title'        => "৫২ পর্বে শেষ হচ্ছে আলোচিত ধারাবাহিক",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "টিভি শো",
                        'title'            => "বাবার মৃত্যু দৃশ্যে কাঁদছেন ‘এটা আমাদেরই গল্প’র দর্শক",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "টিভি শো",
                        'title'            => "দর্শকের পছন্দে এগিয়ে ‘পরান পাখি’",
                        'sub_title'        => "",
                        ...
                        'published_at'     => "2026-04-14 11:45",
                    ],

                    (object) [
                        "category_name"    => "টিভি শো",
                        'title'            => "প্রচারে আসছে নতুন ধারাবাহিক ‘কিচেন পলিটিক্স’",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "টিভি শো",
                        'title'            => "নয় বছর পর প্রচারে আসছে শখ-নিলয়ের ‘কিডন্যাপ’",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        ...
                        'published_at'     => "2026-03-25 20:24",
                    ],

                    (object) [
                        "category_name"    => "তারকা",
                        'title'            => "মেরিল-প্রথম আলো পুরস্কারে কার হাতে কোন সম্মাননা",
                        'sub_title'        => "টিভি, ওয়েব ও চলচ্চিত্রের সেরা কাজের স্বীকৃতি",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "তারকা",
                        'title'            => "চলচ্চিত্র পরিচালনায় নতুন পরিচয়ে পলাশ",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "তারকা",
                        'title'            => "জয়ার নতুন ডিজিটাল যাত্রা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "তারকা",
                        'title'            => "মৌসুমীর প্রত্যাবর্তনে প্রবাসজীবনের গল্প",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ওটিটি",
                        'title'            => "মে মাসে দেখতে পারেন নতুন ৭ সিনেমা–সিরিজ",
                        'sub_title'        => "প্রেক্ষাগৃহ ও ওটিটির নতুন মুক্তির তালিকা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ওটিটি",
                        'title'            => "ওটিটিতে ফিরছে ‘সিটাডেল’–এর দ্বিতীয় মৌসুম",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ওটিটি",
                        'title'            => "নেটফ্লিক্সে আসছে সাইফ আলী খানের ‘কর্তব্য’",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "ওটিটি",
                        'title'            => "ওটিটিতে আলোচিত নতুন সিরিজের তালিকা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        ...
                        'published_at'     => "2026-04-14 17:59",
                    ],

                    (object) [
                        "category_name"    => "ওটিটি",
                        'title'            => "ওটিটি দর্শকের জন্য মে মাসের থ্রিলার ও অ্যাকশন কনটেন্ট",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "ডেঙ্গু প্রতিরোধে পরিচ্ছন্নতায় জোর দিলেন স্বাস্থ্যমন্ত্রী",
                        'sub_title'        => "চিকিৎসার চেয়ে প্রতিরোধকে গুরুত্ব দেওয়ার আহ্বান",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্বাস্থ্য",
                        'title'            => "স্বাস্থ্যকেন্দ্রে ১০ জন করে আনসার মোতায়েনের উদ্যোগ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্বাস্থ্য",
                        'title'            => "ভেজাল ওষুধ ও অপচিকিৎসা ঠেকাতে বাড়বে মোবাইল টিম",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "স্বাস্থ্য",
                        'title'            => "হামের টিকা পেয়েছে ৮১ শতাংশ শিশু",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্বাস্থ্য",
                        'title'            => "হাম ও উপসর্গে আরও ১০ জনের মৃত্যু",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "রাজধানীর টিবি হাসপাতালে ৩ মিলিয়ন ডলারের সরঞ্জাম দিল যুক্তরাষ্ট্র",
                        'sub_title'        => "যক্ষ্মা শনাক্ত ও শিশুচিকিৎসায় নতুন সহায়তা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "চিকিৎসা সংবাদ",
                        'title'            => "মোবাইল ইউনিটে গ্রামেই হবে হৃদরোগের জটিল চিকিৎসা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "চিকিৎসা সংবাদ",
                        'title'            => "ক্যানসার মানেই মৃত্যু নয়: মেয়র শাহাদাত",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "চিকিৎসা সংবাদ",
                        'title'            => "চিকিৎসক আছে, রোগী আছে, নেই রোগ নির্ণয়ের যন্ত্র",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "চিকিৎসা সংবাদ",
                        'title'            => "জেলা হাসপাতালকে রেফারেল সেন্টার করতে চায় সরকার",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "হামের টিকাদানে ৮১ শতাংশ অগ্রগতি",
                        'sub_title'        => "শতভাগ শিশুকে টিকার আওতায় আনার লক্ষ্য",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জনস্বাস্থ্য",
                        'title'            => "ডিএনসিসির ৫৯৯ কেন্দ্রে হাম-রুবেলার টিকা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জনস্বাস্থ্য",
                        'title'            => "কলেরা নিয়ন্ত্রণে পরীক্ষামূলক গবেষণা শুরু করবে আইসিডিডিআরবি",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "জনস্বাস্থ্য",
                        'title'            => "ই–সিগারেটের নিষেধাজ্ঞামুক্তি নিয়ে জনস্বাস্থ্যবিদদের উদ্বেগ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জনস্বাস্থ্য",
                        'title'            => "জলবায়ু পরিবর্তনে সংক্রামক রোগের ঝুঁকি বাড়ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        ...
                        'published_at'     => "2026-04-06 00:00",
                    ],

                    (object) [
                        "category_name"    => "রোগ",
                        'title'            => "হাম ও উপসর্গে মৃতের সংখ্যা বাড়ছে",
                        'sub_title'        => "শিশুদের টিকাদান ও দ্রুত চিকিৎসার আহ্বান",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "রোগ",
                        'title'            => "হাম ও রুবেলার পার্থক্য জানালেন বিশেষজ্ঞ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        ...
                        'published_at'     => "2026-04-06 02:00",
                    ],

                    (object) [
                        "category_name"    => "রোগ",
                        'title'            => "হিট স্ট্রোকের আগে শরীর যে সংকেত দেয়",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "রোগ",
                        'title'            => "পা ফোলা কি গুরুতর রোগের লক্ষণ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        ...
                        'published_at'     => "2026-04-17 06:00",
                    ],

                    (object) [
                        "category_name"    => "রোগ",
                        'title'            => "টেস্টোস্টেরন কমে গেলে যেসব সমস্যা হতে পারে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "জাতীয় পুষ্টি সপ্তাহ শুরু",
                        'sub_title'        => "পুষ্টি বৈষম্য দূর করে স্বনির্ভর বাংলাদেশ গড়ার বার্তা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "পুষ্টি",
                        'title'            => "প্যাকেটজাত খাদ্যে সহজবোধ্য পুষ্টি লেবেলিংয়ের দাবি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "পুষ্টি",
                        'title'            => "মাতৃদুগ্ধ পান বাড়াতে ইউনিয়ন পর্যায়ে কাউন্সেলিংয়ের নির্দেশনা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "পুষ্টি",
                        'title'            => "পান্তাভাতে পুষ্টিগুণ বাড়ে, জানালেন পুষ্টিবিদ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                        ...
                        'published_at'     => "2026-04-08 13:44",
                    ],

                    (object) [
                        "category_name"    => "পুষ্টি",
                        'title'            => "সকালের নাশতায় ফাইবার ও উদ্ভিজ্জ প্রোটিনের পরামর্শ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "বাংলাদেশে মানসিক স্বাস্থ্য সংকট গভীর হচ্ছে",
                        'sub_title'        => "চিকিৎসার বাইরে রয়ে যাচ্ছে বড় অংশ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "মানসিক স্বাস্থ্য",
                        'title'            => "স্নায়ু শিথিল রাখতে পাঁচ সহজ অভ্যাস",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "মানসিক স্বাস্থ্য",
                        'title'            => "ঘুম থেকে উঠেই ফোন দেখা মনোযোগ কমাতে পারে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "মানসিক স্বাস্থ্য",
                        'title'            => "বুননের কাজ মানসিক অস্থিরতা কমাতে সহায়ক হতে পারে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "মানসিক স্বাস্থ্য",
                        'title'            => "মস্তিষ্ক সুস্থ রাখতে ঘুম, সামাজিক জীবন ও স্ট্রেস নিয়ন্ত্রণ জরুরি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "জাতীয় বিশ্ববিদ্যালয়ের ভর্তি পরীক্ষার ফল প্রকাশ",
                        'sub_title'        => "দুইভাবে ফল জানতে পারছেন ভর্তিচ্ছুরা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "শিক্ষা",
                        'title'            => "জাতীয় বিশ্ববিদ্যালয়ে স্নাতক প্রথম বর্ষের ক্লাস শুরু ২ জুন",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "শিক্ষা",
                        'title'            => "২০২৫-২৬ শিক্ষাবর্ষের মেডিকেল শিক্ষার্থীদের ক্লাস শুরু",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "শিক্ষা",
                        'title'            => "শাবিপ্রবির ১৮৬ শিক্ষার্থী পেল গবেষণা অনুদান",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "শিক্ষা",
                        'title'            => "ব্রিটিশ কাউন্সিলের পার্টনার স্কুলস নেটওয়ার্কে দক্ষতা উন্নয়ন",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্কুল",
                        'title'            => "এসএসসি পরীক্ষার্থী ১৮ লাখ ৫৭ হাজারের বেশি",
                        'sub_title'        => "সারাদেশে ১১ শিক্ষা বোর্ডের অধীনে পরীক্ষা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্কুল",
                        'title'            => "নিবন্ধনের পরও এসএসসি দিচ্ছে না সাড়ে ৪ লাখ শিক্ষার্থী",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্কুল",
                        'title'            => "স্কুল ফিডিংয়ের খাবারে অসুস্থতার ঘটনায় কঠোর নির্দেশ",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "স্কুল",
                        'title'            => "দারুননাজাত একাডেমিতে ইংরেজি বিতর্ক প্রতিযোগিতা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "স্কুল",
                        'title'            => "প্রাথমিক বিদ্যালয়ে বিনা মূল্যে ইউনিফর্ম দেওয়ার উদ্যোগ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "রুয়েটে প্রথম বর্ষের ক্লাস শুরু ১০ মে",
                        'sub_title'        => "নবীন শিক্ষার্থীদের ওরিয়েন্টেশন ৯ মে",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ববিদ্যালয়",
                        'title'            => "ঢাকা সেন্ট্রাল ইউনিভার্সিটির ভর্তি আবেদন মে মাসে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ববিদ্যালয়",
                        'title'            => "উচ্চশিক্ষার হিট প্রকল্প দ্রুত বাস্তবায়নের নির্দেশ",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ববিদ্যালয়",
                        'title'            => "গ্রামীণ বিশ্ববিদ্যালয়ের পরামর্শক হলেন নিয়াজ আহমদ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিশ্ববিদ্যালয়",
                        'title'            => "জাতীয় বিশ্ববিদ্যালয়ে ৮৮০ কলেজে ভর্তি কার্যক্রম শুরু হচ্ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "এইচএসসি পরীক্ষা শুরু হবে ২ জুলাই",
                        'sub_title'        => "প্রায় পাঁচ সপ্তাহ ধরে চলবে পরীক্ষা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "পরীক্ষা",
                        'title'            => "এসএসসি পরীক্ষা শুরু, মানতে হবে ১৪ নির্দেশনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "পরীক্ষা",
                        'title'            => "এসএসসির দ্বিতীয় দিনে অনুপস্থিত ২৬ হাজারের বেশি",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "পরীক্ষা",
                        'title'            => "এসএসসির ফল ৬০ দিনের আগেই প্রকাশের লক্ষ্য",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "পরীক্ষা",
                        'title'            => "পাবলিক পরীক্ষায় ‘নীরব বহিষ্কার’ প্রথা বাদ দেওয়ার উদ্যোগ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "এইচএসসি শিক্ষার্থীদের ভর্তি সহায়তার আবেদনের সময় বাড়ল",
                        'sub_title'        => "অসচ্ছল মেধাবীরা পাবে ৬ হাজার টাকা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বৃত্তি",
                        'title'            => "ব্র্যাকের মেধাবিকাশ বৃত্তির সময় বৃদ্ধি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বৃত্তি",
                        'title'            => "কারিগরি ও মাদ্রাসা শিক্ষার্থীদের বিশেষ মঞ্জুরি",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "বৃত্তি",
                        'title'            => "বাংলাদেশিদের জন্য যুক্তরাজ্যে স্কলারশিপ বাড়ানোর আহ্বান",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বৃত্তি",
                        'title'            => "স্কুল-কলেজ-মাদ্রাসা ও বিশ্ববিদ্যালয়ে শিক্ষাবৃত্তি বাড়ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "ঢাকার কিছু প্রতিষ্ঠানে অনলাইন-অফলাইন ক্লাসের পরীক্ষামূলক পরিকল্পনা",
                        'sub_title'        => "সপ্তাহে তিন দিন অনলাইন, তিন দিন সশরীর ক্লাস",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "শিক্ষানীতি",
                        'title'            => "প্রাথমিক শিক্ষা ধাপে ধাপে অষ্টম শ্রেণি পর্যন্ত করার পরিকল্পনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "শিক্ষানীতি",
                        'title'            => "ভর্তি পরীক্ষার দীর্ঘসূত্রতায় সময় অপচয় কমাতে সমন্বিত ব্যবস্থার তাগিদ",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "শিক্ষানীতি",
                        'title'            => "প্রশ্নফাঁস ও কোচিং বাণিজ্য নিয়ন্ত্রণে কঠোর অবস্থান",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "শিক্ষানীতি",
                        'title'            => "বুলিং ও ইভটিজিং ঠেকাতে ৫১৭ শিক্ষাপ্রতিষ্ঠানে সিসিটিভি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "কান ফোঁড়ানোর আগে-পরে যত্ন না নিলে বাড়তে পারে সংক্রমণ",
                        'sub_title'        => "সৌন্দর্যচর্চায় পরিচ্ছন্নতা ও সঠিক পরবর্তী যত্ন জরুরি",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জীবনধারা",
                        'title'            => "ঘরে বানানো টার্মারিক বুস্টারে বাড়তে পারে রোগপ্রতিরোধ ক্ষমতা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জীবনধারা",
                        'title'            => "ব্যস্ততার ভিড়ে হারিয়ে যাচ্ছে নিজের জন্য সময়",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "জীবনধারা",
                        'title'            => "গরমে মেকআপ দীর্ঘস্থায়ী রাখতে হালকা বেসের পরামর্শ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জীবনধারা",
                        'title'            => "ত্বক ও চুলের যত্নে আমলকী ব্যবহারে আগ্রহ বাড়ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "সারা লাইফস্টাইলের ঈদুল আজহা কালেকশনে বৈচিত্র্যময় পোশাক",
                        'sub_title'        => "সব বয়স ও রুচির ক্রেতার জন্য সাজানো উৎসব সংগ্রহ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ফ্যাশন",
                        'title'            => "মেরিল-প্রথম আলো পুরস্কারে তারকাদের ব্লাউজ নকশায় নতুনত্ব",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ফ্যাশন",
                        'title'            => "ছোট চুলে নজর কাড়লেন মডেল ও অভিনেত্রী পিয়া",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "ফ্যাশন",
                        'title'            => "বৈশাখের রঙিন সাজে নতুন তাঁতের পোশাক",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ফ্যাশন",
                        'title'            => "প্যান্ট ও ব্যাগের চেইনে YKK লেখা কেন থাকে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ভ্রমণ",
                        'title'            => "ঢাকার কাছেই সবুজে ঘেরা জিন্দা পার্কে পরিবার নিয়ে ঘোরার সুযোগ",
                        'sub_title'        => "শহরের কোলাহল থেকে স্বল্প দূরত্বের প্রকৃতি ভ্রমণ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ভ্রমণ",
                        'title'            => "পদ্মায় হাউসবোট ভ্রমণে বাড়ছে পর্যটকদের আগ্রহ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ভ্রমণ",
                        'title'            => "ঢাকা ট্রাভেল মার্টে অংশ নেয় ৫০টির বেশি প্রতিষ্ঠান",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "ভ্রমণ",
                        'title'            => "নববর্ষে হোটেল-রিসোর্টে বৈশাখী আয়োজন",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "ভ্রমণ",
                        'title'            => "কক্সবাজারকে বিশ্বমানের পর্যটন গন্তব্য করার প্রত্যাশা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "খাবার",
                        'title'            => "পান্তা খাওয়ার নানা স্বাদে বৈশাখী খাবারের স্মৃতি",
                        'sub_title'        => "ইলিশ, কচুর মুখি ও শুকনা মরিচে পান্তার ভিন্ন স্বাদ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "খাবার",
                        'title'            => "কাঁচা আমের শরবতে গরমে স্বস্তির স্বাদ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "খাবার",
                        'title'            => "টার্মারিক বুস্টার ঘরেই বানিয়ে পান করতে পারেন",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "খাবার",
                        'title'            => "ঈদ স্পেশাল আয়োজনে কাচ্চি, রেজালা ও বোরহানি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "খাবার",
                        'title'            => "মিন্ট লেমন বানিয়ে ঘরে পান করুন সতেজ শরবত",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "মানুষ জীবনে গড়ে দুইবার গভীর প্রেমে পড়ে",
                        'sub_title'        => "গবেষণায় প্রেমের অভিজ্ঞতা নিয়ে নতুন আলোচনা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সম্পর্ক",
                        'title'            => "সংসারের অশান্তি কমাতে আলোচনায় ৫-৫-৫ ফর্মুলা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সম্পর্ক",
                        'title'            => "যৌথ পরিবারে দাম্পত্য শান্তির জন্য দরকার স্পষ্ট যোগাযোগ",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "সম্পর্ক",
                        'title'            => "ঈদের ছুটি হতে পারে পরিবারের যত্ন নেওয়ার সময়",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সম্পর্ক",
                        'title'            => "শহুরে একাকীত্বে ফ্ল্যাটবাড়ির মানুষও বিচ্ছিন্ন হয়ে পড়ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "গানে গানে শুরু হয় প্রথম আলো বৈশাখী উৎসব",
                        'sub_title'        => "নাগরদোলা, গান ও লোকজ আয়োজনে নববর্ষের আবহ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সংস্কৃতি",
                        'title'            => "রমনার বটমূলে সুরের মূর্ছনায় নতুন বছর বরণ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সংস্কৃতি",
                        'title'            => "নববর্ষের শোভাযাত্রার নাম হলো বৈশাখী শোভাযাত্রা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "সংস্কৃতি",
                        'title'            => "জাতীয়ভাবে বাংলা নববর্ষ উদ্‌যাপনে বিস্তৃত কর্মসূচি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "সংস্কৃতি",
                        'title'            => "শিল্পকলা একাডেমির পাঁচ দিনব্যাপী বৈশাখী উৎসব",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "ব্যাটারির চার্জ শেষ হলে নিজেই বদলে নেয় রোবট",
                        'sub_title'        => "রোবট প্রযুক্তিতে স্বয়ংসম্পূর্ণতার নতুন উদাহরণ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিজ্ঞান",
                        'title'            => "সিলিং ফ্যানে ক্যাপাসিটরের কাজ কী",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিজ্ঞান",
                        'title'            => "মেগা এল নিনো নিয়ে বিজ্ঞানীদের সতর্কতা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "বিজ্ঞান",
                        'title'            => "স্যাটেলাইট ছবিতে সবুজ আভায় দেখা গেল বাংলাদেশ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বিজ্ঞান",
                        'title'            => "জাতীয় বিজ্ঞান ও প্রযুক্তি সপ্তাহে উদ্ভাবনের বার্তা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "ঢাকার বিজ্ঞান জাদুঘরে ইউরি গ্যাগারিনের আবক্ষ মূর্তি",
                        'sub_title'        => "মানব মহাকাশযাত্রার ৬৫ বছর পূর্তিতে বিশেষ আয়োজন",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "মহাকাশ",
                        'title'            => "মহাকাশ থেকে লিরিড উল্কাবৃষ্টির বিরল ছবি প্রকাশ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "মহাকাশ",
                        'title'            => "কালপুরুষ চিনতে আকাশ পর্যবেক্ষণের সহজ উপায়",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "মহাকাশ",
                        'title'            => "ধ্রুবতারা চিনে উত্তর দিক নির্ণয়ের পাঠ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "মহাকাশ",
                        'title'            => "আর্টেমিস-২ মিশন ঘিরে চাঁদে ফেরার প্রস্তুতি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "শাবিপ্রবির ১৮৬ শিক্ষার্থী পেল গবেষণা অনুদান",
                        'sub_title'        => "শিক্ষার্থীদের গবেষণায় উৎসাহ দিতে প্রশাসনের উদ্যোগ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "গবেষণা",
                        'title'            => "উত্তরা ইউনিভার্সিটিতে ৪০টি গবেষণা প্রস্তাবনা উপস্থাপন",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "গবেষণা",
                        'title'            => "এআই গবেষণা ও স্টার্টআপে ড্যাফোডিলে হ্যাকাথন",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "গবেষণা",
                        'title'            => "আইএইএর সঙ্গে বাংলাদেশের পরমাণু সহযোগিতা জোরদার",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "গবেষণা",
                        'title'            => "মরুভূমিকে উর্বর মাটিতে রূপান্তরের গবেষণা আলোচনায়",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "পানি দিয়ে চলবে গ্রিন হাইড্রোজেন স্টোভ",
                        'sub_title'        => "গ্যাসের বিকল্প রান্নার প্রযুক্তি নিয়ে নতুন আলোচনা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "উদ্ভাবন",
                        'title'            => "বিশ্বের প্রথম কোয়ান্টাম ব্যাটারির নমুনা তৈরি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "উদ্ভাবন",
                        'title'            => "ভাইটাল আইডি পাসওয়ার্ডের বদলে খুলির কম্পন ব্যবহার করবে",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "উদ্ভাবন",
                        'title'            => "ইনকিউবেশন হাব চালু হলো রাজশাহী বিশ্ববিদ্যালয়ে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "উদ্ভাবন",
                        'title'            => "দৃষ্টিপ্রতিবন্ধীদের জন্য স্মার্ট গ্লাস নিয়ে বিশ্বমঞ্চে শাবিপ্রবি দল",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "স্মার্টফোনের দাম ২৫০০ টাকায় আনতে চায় সরকার",
                        'sub_title'        => "ডিজিটাল অন্তর্ভুক্তি বাড়াতে কমদামি ডিভাইসের পরিকল্পনা",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "প্রযুক্তি গবেষণা",
                        'title'            => "ঢাবির ১০ বিভাগ কিউএস র‍্যাঙ্কিংয়ে বিশ্বসেরার তালিকায়",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "প্রযুক্তি গবেষণা",
                        'title'            => "রূপপুর পারমাণবিক বিদ্যুৎকেন্দ্রের অগ্রগতি আলোচনায়",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "প্রযুক্তি গবেষণা",
                        'title'            => "বিজ্ঞান ও প্রযুক্তি মন্ত্রণালয়ে নতুন গবেষণা প্রস্তাবনার প্রস্তুতি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "প্রযুক্তি গবেষণা",
                        'title'            => "ন্যানো-ডোওপ অ্যাপে উপকূলের জীববৈচিত্র্যের তথ্য",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "৬ হাজারের বেশি এক্সোপ্ল্যানেট নিশ্চিত করেছেন বিজ্ঞানীরা",
                        'sub_title'        => "সৌরজগতের বাইরে প্রাণের সম্ভাবনা নিয়ে নতুন আগ্রহ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বৈজ্ঞানিক আবিষ্কার",
                        'title'            => "মাথার খুলির কম্পনে পরিচয় শনাক্তের নতুন পদ্ধতি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বৈজ্ঞানিক আবিষ্কার",
                        'title'            => "সায়ানোব্যাকটেরিয়ায় মরুভূমির বালু স্থিতিশীল করার পদ্ধতি",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "বৈজ্ঞানিক আবিষ্কার",
                        'title'            => "নিঃশব্দ সুপারসনিক জেট এক্স-৫৯ পরীক্ষায় সফল",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বৈজ্ঞানিক আবিষ্কার",
                        'title'            => "কোয়ান্টাম ব্যাটারি শক্তি সংরক্ষণে নতুন দিগন্ত দেখাচ্ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "টানা বৃষ্টির পরও ঢাকার বাতাস অস্বাস্থ্যকর",
                        'sub_title'        => "বৃষ্টির পরও কমছে না রাজধানীর বায়ুদূষণ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "পরিবেশ",
                        'title'            => "সপ্তাহজুড়ে রোদ-বৃষ্টির পূর্বাভাস",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "পরিবেশ",
                        'title'            => "মে মাসে কালবৈশাখী ও লঘুচাপের সম্ভাবনা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "পরিবেশ",
                        'title'            => "ভোলায় কালবৈশাখী ঝড়ে অর্ধশতাধিক ঘর ক্ষতিগ্রস্ত",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "পরিবেশ",
                        'title'            => "জাতীয় বৃক্ষরোপণ অভিযান ও বৃক্ষমেলার প্রস্তুতি",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "বাংলাদেশে শীতকাল ছোট হয়ে আসছে",
                        'sub_title'        => "গবেষণায় ভবিষ্যৎ জলবায়ুর উদ্বেগজনক চিত্র",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জলবায়ু পরিবর্তন",
                        'title'            => "রাতের তাপমাত্রা দ্রুত বাড়া স্বাস্থ্যঝুঁকি বাড়াচ্ছে",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জলবায়ু পরিবর্তন",
                        'title'            => "তাপপ্রবাহের ঝুঁকিতে রংপুর, রাজশাহী ও খুলনা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "জলবায়ু পরিবর্তন",
                        'title'            => "তাপমাত্রা বৃদ্ধিতে কৃষি ও মৎস্য খাতে ক্ষতির আশঙ্কা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "জলবায়ু পরিবর্তন",
                        'title'            => "ঋতুচক্র অস্বাভাবিক হচ্ছে, বাড়ছে নগর দুর্যোগ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "দূষণ",
                        'title'            => "ঢাকার বায়ুমান ১৫৫, অস্বাস্থ্যকর অবস্থায় রাজধানী",
                        'sub_title'        => "আইকিউএয়ারের সূচকে দূষণের উচ্চ ঝুঁকি",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "দূষণ",
                        'title'            => "উত্তর বাড্ডায় বায়ুমান খুব অস্বাস্থ্যকর",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "দূষণ",
                        'title'            => "নির্মাণসামগ্রী দিয়ে বায়ুদূষণে মোবাইল কোর্ট",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "দূষণ",
                        'title'            => "ইটিপি ছাড়া কারখানায় নদী দূষণবিরোধী অভিযান",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "দূষণ",
                        'title'            => "শব্দদূষণ নিয়ন্ত্রণে প্রশিক্ষণ ও সচেতনতা কার্যক্রম",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "বন্যপ্রাণী সুরক্ষায় নতুন অধ্যাদেশ জারি",
                        'sub_title'        => "জীববৈচিত্র্য সংরক্ষণে আইনি কাঠামো শক্তিশালী",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বন্যপ্রাণী",
                        'title'            => "শেরপুরে হাতির ভয়ে আগাম ধান কাটছেন কৃষকরা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বন্যপ্রাণী",
                        'title'            => "রামুতে বন্য হাতির আক্রমণে মা-মেয়ের মৃত্যু",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "বন্যপ্রাণী",
                        'title'            => "সুন্দরবনে চোরা শিকারিদের ফাঁদে বিপন্ন প্রাণী",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "বন্যপ্রাণী",
                        'title'            => "কুয়াকাটায় আবারও মৃত ডলফিন ভেসে এলো",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "মে মাসে লঘুচাপ, কালবৈশাখী ও তাপপ্রবাহের পূর্বাভাস",
                        'sub_title'        => "আবহাওয়ার অস্থিরতায় প্রস্তুতির পরামর্শ",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "প্রাকৃতিক দুর্যোগ",
                        'title'            => "সমুদ্রবন্দরে সতর্কসংকেত, চার বিভাগে ভারী বৃষ্টির পূর্বাভাস",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "প্রাকৃতিক দুর্যোগ",
                        'title'            => "কুমিল্লায় দেড় ঘণ্টার বৃষ্টিতে ভয়াবহ জলাবদ্ধতা",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "প্রাকৃতিক দুর্যোগ",
                        'title'            => "নোয়াখালীতে ঝড়ে ঘর হারিয়ে খোলা আকাশের নিচে পরিবার",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "প্রাকৃতিক দুর্যোগ",
                        'title'            => "ভোলায় আকস্মিক ঝড়ে গাছ উপড়ে যান চলাচল ব্যাহত",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        ...
                        'title'            => "নবায়নযোগ্য জ্বালানিতে টেকসই ভবিষ্যতের বার্তা",
                        'sub_title'        => "জ্বালানি নিরাপত্তায় সৌর, বায়ু ও বায়োমাসের গুরুত্ব",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "টেকসই উন্নয়ন",
                        'title'            => "উপকূলে লবণাক্ততা টেকসই উন্নয়নের বড় চ্যালেঞ্জ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "টেকসই উন্নয়ন",
                        'title'            => "সেন্টমার্টিন রক্ষায় টেকসই মাস্টারপ্ল্যানের তাগিদ",
                        'sub_title'        => "",
                    ...
                    (object) [
                        "category_name"    => "টেকসই উন্নয়ন",
                        'title'            => "বিশ্বব্যাংকের সঙ্গে পরিবেশ ও টেকসই উন্নয়ন আলোচনা",
                        'sub_title'        => "",
                        'content_shoulder' => "",
                    ...
                    (object) [
                        "category_name"    => "টেকসই উন্নয়ন",
                        'title'            => "নিম্ন-কার্বন উন্নয়ন কৌশল প্রণয়নের উদ্যোগ",
                        'sub_title'        => "",
                        'content_shoulder' => "",
