    ...
    private function eventsByLanguageGroups()
    {
        return collect([
            ...
            (object) [
                ...
                'events'        => collect([
                    (object) ['name' => 'মে দিবস', 'start_date' => '2026-05-01', 'end_date' => '2026-05-01', 'details' => 'আন্তর্জাতিক শ্রমিক দিবস', 'seo_keywords' => 'শ্রমিক দিবস'],
                    (object) ['name' => 'ঈদুল আজহা', 'start_date' => '2026-06-17', 'end_date' => '2026-06-20', 'details' => 'কুরবানির উৎসব', 'seo_keywords' => 'ঈদুল আজহা, কুরবানি'],
                    (object) ['name' => 'আশুরা', 'start_date' => '2026-07-27', 'end_date' => '2026-07-27', 'details' => 'ইসলামিক স্মরণ দিবস', 'seo_keywords' => 'আশুরা'],
                    (object) ['name' => 'জাতীয় শোক দিবস', 'start_date' => '2026-08-15', 'end_date' => '2026-08-15', 'details' => 'শ্রদ্ধা নিবেদনের দিন', 'seo_keywords' => 'শোক দিবস'],
                    (object) ['name' => 'দুর্গাপূজা', 'start_date' => '2026-10-20', 'end_date' => '2026-10-24', 'details' => 'হিন্দু ধর্মীয় উৎসব', 'seo_keywords' => 'দুর্গাপূজা'],
                    (object) ['name' => 'দীপাবলি', 'start_date' => '2026-11-08', 'end_date' => '2026-11-08', 'details' => 'আলোর উৎসব', 'seo_keywords' => 'দীপাবলি'],
                    (object) ['name' => 'বিজয় দিবস', 'start_date' => '2026-12-16', 'end_date' => '2026-12-16', 'details' => 'বিজয়ের উদযাপন', 'seo_keywords' => 'বিজয় দিবস'],
                    (object) ['name' => 'বড়দিন', 'start_date' => '2026-12-25', 'end_date' => '2026-12-25', 'details' => 'খ্রিস্টান ধর্মীয় উৎসব', 'seo_keywords' => 'বড়দিন'],

                    (object) ['name' => 'এপ্রিল ফুলস ডে', 'start_date' => '2026-04-01', 'end_date' => '2026-04-01', 'details' => 'মজার ঠাট্টার দিন', 'seo_keywords' => 'এপ্রিল ফুল'],
                    (object) ['name' => 'পহেলা বৈশাখ', 'start_date' => '2026-04-14', 'end_date' => '2026-04-14', 'details' => 'বাংলা নববর্ষ', 'seo_keywords' => 'পহেলা বৈশাখ'],
                    (object) ['name' => 'বিশ্ব স্বাস্থ্য দিবস', 'start_date' => '2026-04-07', 'end_date' => '2026-04-07', 'details' => 'স্বাস্থ্য সচেতনতা দিবস', 'seo_keywords' => 'স্বাস্থ্য দিবস'],

                    (object) ['name' => 'নববর্ষ', 'start_date' => '2026-01-01', 'end_date' => '2026-01-01', 'details' => 'নতুন বছরের উদযাপন', 'seo_keywords' => 'নববর্ষ'],
                    (object) ['name' => 'আন্তর্জাতিক বইমেলা', 'start_date' => '2026-02-01', 'end_date' => '2026-02-28', 'details' => 'বার্ষিক বইমেলা', 'seo_keywords' => 'বইমেলা'],
                    (object) ['name' => 'ভ্যালেন্টাইনস ডে', 'start_date' => '2026-02-14', 'end_date' => '2026-02-14', 'details' => 'ভালোবাসার দিন', 'seo_keywords' => 'ভ্যালেন্টাইন'],
                    (object) ['name' => 'ভাষা শহীদ দিবস', 'start_date' => '2026-02-21', 'end_date' => '2026-02-21', 'details' => 'আন্তর্জাতিক মাতৃভাষা দিবস', 'seo_keywords' => '২১ ফেব্রুয়ারি'],
                    (object) ['name' => 'আন্তর্জাতিক নারী দিবস', 'start_date' => '2026-03-08', 'end_date' => '2026-03-08', 'details' => 'নারী ক্ষমতায়ন দিবস', 'seo_keywords' => 'নারী দিবস'],
                    (object) ['name' => 'স্বাধীনতা দিবস', 'start_date' => '2026-03-26', 'end_date' => '2026-03-26', 'details' => 'স্বাধীনতার উদযাপন', 'seo_keywords' => 'স্বাধীনতা দিবস'],
                    (object) ['name' => 'শবে বরাত', 'start_date' => '2026-02-26', 'end_date' => '2026-02-26', 'details' => 'ইসলামিক পবিত্র রাত', 'seo_keywords' => 'শবে বরাত'],
                    (object) ['name' => 'ঈদুল ফিতর', 'start_date' => '2026-04-10', 'end_date' => '2026-04-16', 'details' => 'রমজান শেষে উৎসব', 'seo_keywords' => 'ঈদুল ফিতর'],

                    (object) ['name' => 'বিশ্ব পরিবেশ দিবস', 'start_date' => '2026-06-05', 'end_date' => '2026-06-05', 'details' => 'পরিবেশ সচেতনতা', 'seo_keywords' => 'পরিবেশ দিবস'],
                    (object) ['name' => 'বাবা দিবস', 'start_date' => '2026-06-21', 'end_date' => '2026-06-21', 'details' => 'বাবাদের সম্মান জানানো', 'seo_keywords' => 'বাবা দিবস'],
                    (object) ['name' => 'মা দিবস', 'start_date' => '2026-05-10', 'end_date' => '2026-05-10', 'details' => 'মায়েদের সম্মান', 'seo_keywords' => 'মা দিবস'],
                    (object) ['name' => 'যুব দিবস', 'start_date' => '2026-11-01', 'end_date' => '2026-11-01', 'details' => 'যুবকদের উদযাপন', 'seo_keywords' => 'যুব দিবস'],
                    (object) ['name' => 'শিক্ষক দিবস', 'start_date' => '2026-10-05', 'end_date' => '2026-10-05', 'details' => 'শিক্ষকদের সম্মান', 'seo_keywords' => 'শিক্ষক দিবস'],
                    (object) ['name' => 'শবে কদর', 'start_date' => '2026-04-05', 'end_date' => '2026-04-05', 'details' => 'পবিত্র ক্ষমার রাত', 'seo_keywords' => 'লাইলাতুল কদর'],
                ]),
            ],
