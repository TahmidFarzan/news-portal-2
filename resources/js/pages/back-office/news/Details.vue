...
const pageTitle = computed(() => `${news?.title} ${t('labels.details')}`)
    ...
    <div class="w-full space-y-6">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('labels.news_type') }}</span>
                ...
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('news.form.location') }}</span>
                ...
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('news.form.event') }}</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    ...
                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('news.form.sub_title') }}</span>
                        <span class="font-medium">{{ news?.sub_title || notAvailable }}</span>
                    </div>

                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('news.form.content_shoulder') }}</span>
                ...
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div>
                        <div class="text-gray-500 mb-1">{{ t('news.form.brief') }}</div>
            ...
            <div v-if="checkIsStory(news?.news_type)" class="grid grid-cols-1 gap-4 text-sm">
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div>
                        <div class="text-gray-500 mb-1">{{ t('news.form.body') }}</div>
            ...
            <div v-if="checkIsVideo(news?.news_type)" class="grid grid-cols-1 gap-4 text-sm">
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div>
                        <div class="text-gray-500 mb-1">{{ t('news.form.video_url') }}</div>
                        <div class="text-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('news.form.tags') }}</span>
                ...
                <div v-if="checkIsStory(news?.news_type)" class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('labels.contributors') }}</span>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span v-else class="text-sm text-gray-400 italic">
                                {{ t('news.details.no_contributor_added') }}
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div>
                        <div class="text-gray-500 mb-1">{{ t('news.form.feature_image') }}</div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div>
                        <div class="text-gray-500 mb-1">{{ t('news.form.feature_image_mobile') }}</div>
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="text-gray-500 mb-2">{{ t('news.form.seo_settings') }}</div>
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div>
                            <div class="text-gray-500 mb-1">{{ t('news.form.seo_keywords') }}</div>
                            <div class="font-medium text-gray-700">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div v-if="checkIsStory(news?.news_type)" class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('labels.source') }}</span>
                ...
                <div v-if="checkIsStory(news?.news_type)" class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('news.form.writer') }}</span>
                ...
                <div class="border border-gray-200 rounded-lg p-4 space-y-2">
                    <div class="flex justify-between">
                        <span class="text-gray-500">{{ t('labels.published') }}</span>
                        <span class="font-medium">{{ news?.is_published ? t('labels.yes') : t('labels.no') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div v-if="news?.breaking_news" class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 space-y-4">
            ...
            <div class="flex justify-between">
                <span class="text-gray-500">{{ t('labels.published') }}</span>
                <span class="font-medium">
                    {{ news?.breaking_news?.is_published ? t('labels.yes') : t('labels.no') }}
                </span>
            </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 space-y-4">
            <h3 class="text-base font-semibold border-b pb-2">
                {{ t('news.details.news_placements') }}
            </h3>
