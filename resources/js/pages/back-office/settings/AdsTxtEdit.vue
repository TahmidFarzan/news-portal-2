    ...
    window.dispatchEvent(
        new CustomEvent('set-breadcrumb', {
            detail: [
                ...
                {
                    text: t('pages.back_office.settings.ads_txt.edit.labels.title'),
                    active: true,
                },
            ],
        }),
...
<template>
    ...
    <Head :title="t('pages.back_office.settings.ads_txt.edit.labels.title')" />

    <div class="w-full space-y-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-lg font-semibold text-gray-950">
                    {{ t('pages.back_office.settings.ads_txt.edit.labels.title') }}
                </h2>

                <p class="mt-1 text-sm text-gray-500">
                    {{ t('pages.back_office.settings.ads_txt.edit.labels.description') }}
                </p>
            </div>
            ...
            <Link :href="route('back-office.settings.index')"
                ...
                <span>
                    {{ t('pages.back_office.settings.ads_txt.edit.labels.back') }}
                </span>
            </Link>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                    ...
                    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <h3 class="text-sm font-semibold text-gray-950">
                                        {{ t('pages.back_office.settings.ads_txt.edit.labels.content') }}
                                    </h3>

                                    <p class="text-xs text-gray-500">
                                        {{ t('pages.back_office.settings.ads_txt.edit.labels.content_description') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4">
                            <textarea v-model="form.ads_txt" rows="18"
                                ...
                                :placeholder="t('pages.back_office.settings.ads_txt.edit.labels.placeholder')" />
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <button type="submit"
                            ...
                            <span>
                                {{
                                    form.processing
                                        ? t('pages.back_office.settings.ads_txt.edit.labels.saving')
                                        : t('pages.back_office.settings.ads_txt.edit.labels.save')
                                }}
                            </span>
                        </button>
                        ...
                        <button type="button"
                            ...
                            <span>
                                {{ t('pages.back_office.settings.ads_txt.edit.labels.use_example') }}
                            </span>
                        </button>
                        ...
                        <button type="button"
                            ...
                            <span>
                                {{ t('pages.back_office.settings.ads_txt.edit.labels.reset') }}
                            </span>
                        </button>
                    </div>
                </div>
                ...
                <div class="space-y-4 lg:col-span-4">
                    <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                        <h3 class="text-sm font-semibold text-gray-950">
                            {{ t('pages.back_office.settings.ads_txt.edit.labels.help_title') }}
                        </h3>

                        <p class="mt-2 text-sm leading-6 text-gray-500">
                            {{ t('pages.back_office.settings.ads_txt.edit.labels.help_description') }}
                        </p>
                    </div>

                    <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                        <h3 class="text-sm font-semibold text-gray-950">
                            {{ t('pages.back_office.settings.ads_txt.edit.labels.example_title') }}
                        </h3>
