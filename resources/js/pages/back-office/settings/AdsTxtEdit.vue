    ...
    window.dispatchEvent(
        new CustomEvent('set-breadcrumb', {
            detail: [
                ...
                {
                    text: t('common.labels.editAdsTxt'),
                    active: true,
                },
            ],
        }),
...
<template>
    ...
    <Head :title="t('common.labels.editAdsTxt')" />

    <div class="w-full space-y-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-lg font-semibold text-gray-950">
                    {{ t('common.labels.editAdsTxt') }}
                </h2>

                <p class="mt-1 text-sm text-gray-500">
                    {{ t('admin.settings.adsTxt.edit.labels.description') }}
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                    ...
                    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <h3 class="text-sm font-semibold text-gray-950">
                                        {{ t('admin.settings.adsTxt.edit.labels.content') }}
                                    </h3>

                                    <p class="text-xs text-gray-500">
                                        {{ t('admin.settings.adsTxt.edit.labels.contentDescription') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4">
                            <textarea v-model="form.ads_txt" rows="18"
                                ...
                                :placeholder="t('admin.settings.adsTxt.edit.labels.placeholder')" />
                            ...
                            <span>
                                {{
                                    form.processing
                                        ...
                                        : t('admin.settings.adsTxt.edit.labels.save')
                                }}
                            </span>
                        </button>
                ...
                <div class="space-y-4 lg:col-span-4">
                    <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                        <h3 class="text-sm font-semibold text-gray-950">
                            {{ t('admin.settings.adsTxt.edit.labels.helpTitle') }}
                        </h3>

                        <p class="mt-2 text-sm leading-6 text-gray-500">
                            {{ t('admin.settings.adsTxt.edit.labels.helpDescription') }}
                        </p>
                    </div>

                    <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                        <h3 class="text-sm font-semibold text-gray-950">
                            {{ t('admin.settings.adsTxt.edit.labels.exampleTitle') }}
                        </h3>
