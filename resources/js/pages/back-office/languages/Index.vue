...
onMounted(async () => {
    ...
    window.dispatchEvent(
        new CustomEvent('set-breadcrumb', {
            detail: [
                { text: t('pages.back_office.languages.index.navigation.languages'), active: true },
            ],
        })
    )
})
...
<template>
    <Head :title="t('pages.back_office.languages.index.navigation.languages')" />

    <div class="w-full space-y-6">

        <div class="flex justify-between items-center">
            <h2 class="text-lg font-semibold">
                {{ t('pages.back_office.languages.index.navigation.languages') }}
            </h2>

            <a
                v-if="canCreate()"
                :href="route('back-office.languages.create')"
                class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md flex items-center gap-2 transition"
            >
                <FontAwesomeIcon icon="plus" />
                {{ t('pages.back_office.languages.index.actions.create') }}
            </a>
        </div>
        ...
        <form @submit.prevent="applyFilter" class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <MultiSelectInfinityLoadingApi
                    ...
                    :multiple="false"
                    :placeholder="t('pages.back_office.languages.index.labels.per_page')"
                />
                ...
                <MultiSelectInfinityLoadingApi
                    ...
                    :multiple="false"
                    :placeholder="t('pages.back_office.languages.index.labels.created_by')"
                />
                ...
                <input
                    ...
                    :placeholder="t('pages.back_office.languages.index.search_placeholder')"
                    class="w-full border border-gray-200 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
                />
            ...
            <div class="flex justify-end">
                ...
                >
                    ...
                    {{ filterForm.processing ? t('pages.back_office.languages.index.applying_filter') : t('pages.back_office.languages.index.apply_filter') }}
                </button>
            </div>
        </form>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <thead class="bg-gray-50 text-gray-600 text-xs uppercase">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left">{{ t('pages.back_office.languages.index.table.columns.name') }}</th>
                            <th class="px-4 py-3 text-left">{{ t('pages.back_office.languages.index.details.code') }}</th>
                            <th class="px-4 py-3 text-left">{{ t('pages.back_office.languages.index.details.locale') }}</th>
                            <th class="px-4 py-3 text-left">{{ t('pages.back_office.languages.index.created') }}</th>
                            <th class="px-4 py-3 text-right">{{ t('pages.back_office.languages.index.table.columns.action') }}</th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="divide-y">
                        ...
                        >
                            ...
                            <td class="px-4 py-3 text-gray-600">
                                {{ item.code || t('pages.back_office.languages.index.labels.not_available') }}
                            </td>

                            <td class="px-4 py-3 text-gray-600">
                                {{ item.locale || t('pages.back_office.languages.index.labels.not_available') }}
                            </td>

                            <td class="px-4 py-3 text-gray-500">
                                {{ item.created_at ? formatDateTime(item.created_at) : t('pages.back_office.languages.index.labels.not_available') }}
                            </td>
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <a
                                        :href="route('back-office.languages.details', { slug: item.slug })"
                                        class="p-2 rounded-md text-blue-600 hover:bg-blue-50 border"
                                        :title="t('pages.back_office.languages.index.table.menus.details')"
                                    >
                                    ...
                                    <a
                                        v-if="canEdit(item)"
                                        :href="route('back-office.languages.edit', { slug: item.slug })"
                                        class="p-2 rounded-md text-yellow-600 hover:bg-yellow-50 border"
                                        :title="t('pages.back_office.languages.index.table.menus.edit')"
                                    >
                                    ...
                                    <button
                                        ...
                                        :title="t('pages.back_office.languages.index.actions.delete')"
                                    >
                        ...
                        <tr v-if="!languages?.data?.length">
                            <td colspan="6" class="px-4 py-6 text-center text-gray-500">
                                {{ t('pages.back_office.languages.index.labels.no_record_found') }}
                            </td>
                        </tr>
                    </tbody>
                    ...
                    >
                        ...
                        >
                            <h3 class="text-lg font-semibold text-red-600">
                                {{ t('pages.back_office.languages.index.delete_modal.title') }}
                            </h3>
                            ...
                            <p class="text-sm text-gray-500">
                                {{ t('pages.back_office.languages.index.modals.delete_confirmation_modal.irreversible_body') }}
                            </p>
                            ...
                            <div class="flex justify-end gap-2 pt-2">
                                ...
                                >
                                    {{ t('pages.back_office.languages.index.actions.cancel') }}
                                </button>
                                ...
                                >
                                    ...
                                    {{ deleteProcessing ? t('pages.back_office.languages.index.actions.deleting') : t('pages.back_office.languages.index.actions.delete') }}
                                </button>
                            </div>
                        </div>
                    </Transition>
