...
onMounted(async () => {
    ...
    window.dispatchEvent(
        new CustomEvent('set-breadcrumb', {
            detail: [
                { text: t('layout_menus.languages'), active: true },
            ],
        })
    )
})
...
<template>
    <Head :title="t('layout_menus.languages')" />
        ...
        <form @submit.prevent="applyFilter" class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <input
                    ...
                    :placeholder="t('languages.index.search_placeholder')"
                    class="w-full border border-gray-200 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
                />
            ...
            <div class="flex justify-end">
                ...
                >
                    ...
                    {{ filterForm.processing ? t('languages.index.applying_filter') : t('languages.index.apply_filter') }}
                </button>
            </div>
        </form>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <thead class="bg-gray-50 text-gray-600 text-xs uppercase">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left">{{ t('languages.details.code') }}</th>
                            <th class="px-4 py-3 text-left">{{ t('languages.details.locale') }}</th>
                            <th class="px-4 py-3 text-left">{{ t('languages.index.created') }}</th>
                    ...
                    <tbody class="divide-y">
                        ...
                        >
                            ...
                            <td class="px-4 py-3 text-gray-600">
                                {{ item.code || t('labels.not_available') }}
                            </td>

                            <td class="px-4 py-3 text-gray-600">
                                {{ item.locale || t('labels.not_available') }}
                            </td>
