...
const pageTitle = computed(() => {
    return isUpdate.value
        ? `${contributor?.name} ${t('pages.back_office.contributors.details.labels.edit')}`
        : t('pages.back_office.contributors.details.form.create_page_title')
})
...
function validateForm() {
    ...
    if (!saveForm.name) {
        saveForm.setError('name', t('pages.back_office.contributors.details.validation.name_is_required'))
        valid = false
    }

    if (!saveForm.language_id) {
        saveForm.setError('language_id', t('pages.back_office.contributors.details.validation.language_is_required'))
        valid = false
    }
...
onMounted(async () => {
    ...
    window.dispatchEvent(
        new CustomEvent('set-breadcrumb', {
            detail: [
                { text: t('pages.back_office.contributors.details.navigation.contributors'), href: route('back-office.contributors.index') },
            ...
            <form @submit.prevent="handleSave" class="space-y-6">
                ...
                <div class="bg-white border rounded-xl p-5 shadow-sm space-y-4">
                    <h3 class="text-base font-semibold">
                        {{ t('pages.back_office.contributors.details.labels.basic_information') }}
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1">
                                {{ t('pages.back_office.contributors.details.labels.language') }} <span class="text-red-500">*</span>
                            </label>
                            ...
                            <SelectInfinityLoadingApi :form="saveForm" fieldName="language_id"
                                ...
                                :placeholder="t('pages.back_office.contributors.details.form.language_placeholder')" />
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1">
                                {{ t('pages.back_office.contributors.details.labels.name') }} <span class="text-red-500">*</span>
                            </label>

                            <input v-model="saveForm.name" :placeholder="t('pages.back_office.contributors.details.form.name_placeholder')"
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium mb-1">
                                {{ t('pages.back_office.contributors.details.form.brief') }}
                            </label>

                            <textarea v-model="saveForm.brief" rows="4"
                                :placeholder="t('pages.back_office.contributors.details.form.brief_placeholder')"
                                class="w-full border rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
                ...
                <div class="bg-white border rounded-xl p-5 shadow-sm space-y-4">
                    <h3 class="text-base font-semibold">
                        {{ t('pages.back_office.contributors.details.form.profile_image_section') }}
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1">
                                {{ t('pages.back_office.contributors.details.labels.profile_image') }}
                            </label>
                            ...
                            <img v-else :src="'/uploads/icons/auth/user.png'" :alt="t('pages.back_office.contributors.details.auth.profile.profile_image_alt')"
                ...
                <div class="bg-white border rounded-xl p-5 shadow-sm space-y-4">
                    <h3 class="text-base font-semibold">
                        {{ t('pages.back_office.contributors.details.form.seo_settings') }}
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1">
                                {{ t('pages.back_office.contributors.details.form.seo_title') }}
                            </label>

                            <input v-model="saveForm.seo_title" type="text"
                                :placeholder="t('pages.back_office.contributors.details.form.seo_title_placeholder')"
                                class="w-full border rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
                        ...
                        <div>
                            <label class="block text-sm font-medium mb-1">
                                {{ t('pages.back_office.contributors.details.form.seo_brief') }}
                            </label>

                            <textarea v-model="saveForm.seo_brief" rows="3"
                                :placeholder="t('pages.back_office.contributors.details.form.seo_brief_placeholder')"
                                class="w-full border rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium mb-1">
                                {{ t('pages.back_office.contributors.details.form.seo_keywords') }}
                            </label>
                            ...
                            <SelectTaggable :key="seoKeywordsKey" :selectedItem="saveForm.seo_keywords"
                                ...
                                :placeholder="t('pages.back_office.contributors.details.form.seo_keywords_placeholder')" />
                ...
                <div class="flex justify-center">
                    <button type="submit" :disabled="saveForm.processing"
                        ...
                        {{ saveForm.processing ? t('pages.back_office.contributors.details.actions.saving') : t('pages.back_office.contributors.details.actions.save') }}
                    </button>
                </div>
