...
const pageTitle = computed(() => {
    return isUpdate.value
        ? `${category?.name} ${t('common.actions.edit')}`
        : t('admin.categories.create.form.createPageTitle')
})
...
function validateForm() {
    ...
    if (saveForm.has_parent && !saveForm.parent_id) {
        saveForm.setError('parent_id', t('admin.categories.create.validation.parentCategoryIsRequired'))
        valid = false
    }
