    ...
    <div class="w-full space-y-6">
        ...
        <form @submit.prevent="applyFilter" class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <InfiniteScrollApiSelect :form="filterForm" fieldName="category_id" selectedLabelKey="indentation_name"
                ...
                <InfiniteScrollApiSelect :form="filterForm" fieldName="location_id" selectedLabelKey="indentation_name"
                ...
                <InfiniteScrollApiSelect :form="filterForm" fieldName="event_id" :selectedItem="filterForm.event_id"
