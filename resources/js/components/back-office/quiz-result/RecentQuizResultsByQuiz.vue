...
<template>
    <div>
        ...
        <div v-if="quiz?.quiz_results && quiz?.quiz_results?.length">
            ...
            <div class="overflow-x-auto bg-white border border-gray-200 rounded-xl shadow-sm">
                <table class="min-w-full text-sm text-left">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in quiz?.quiz_results" :key="item.id"
            ...
            <div class="flex justify-center mt-4">
                <a :href="route('back-office.quizzes.quiz-results.index', { slug: quiz.slug })"
