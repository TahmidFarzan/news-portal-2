...
<template>
    <div>
        ...
        <div v-if="quiz?.quiz_questions && quiz?.quiz_questions?.length">
            ...
            <div class="overflow-x-auto bg-white border border-gray-200 rounded-xl shadow-sm">
                <table class="min-w-full text-sm text-left">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in quiz?.quiz_questions" :key="item.id"
            ...
            <div class="flex justify-center mt-4">
                <a :href="route('back-office.quizzes.quiz-questions.index', { slug: quiz.slug })"
