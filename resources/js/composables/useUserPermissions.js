...
export const canEditUser = async (authUser, user) => hasPermission(authUser, groups.User, access.Update)
...
export const canEditCategory = async (authUser, category) => hasPermission(authUser, groups.Category, access.Update)
...
export const canEditTag = async (authUser, tag) => hasPermission(authUser, groups.Tag, access.Update)
...
export const canEditTrend = async (authUser, trend) => hasPermission(authUser, groups.Trend, access.Update)
...
export const canEditLocation = async (authUser, location) => hasPermission(authUser, groups.Location, access.Update)
...
export const canEditEvent = async (authUser, event) => hasPermission(authUser, groups.Event, access.Update)
...
export const canEditContributor = async (authUser, contributor) => hasPermission(authUser, groups.Contributor, access.Update)
...
export const canEditNews = async (authUser, news) => hasPermission(authUser, groups.News, access.Update)
...
export const canEditBreakingNews = async (authUser, breakingNews) => hasPermission(authUser, groups.BreakingNews, access.Update)
...
export const canEditPage = async (authUser, page) => hasPermission(authUser, groups.Page, access.Update)
...
export const canEditMenu = async (authUser, menu) => hasPermission(authUser, groups.Menu, access.Update)
...
export const canEditMenuItem = async (authUser, menuItem) => hasPermission(authUser, groups.MenuItem, access.Update)
...
export const canEditTheme = async (authUser, theme) => hasPermission(authUser, groups.Theme, access.Update)
