...
class CacheHelper
{
    ...
    public static function cacheKeyGenerateSingleRecordById(string $key, string $secondKey, string | int $id, ?Language $language = null)
    {
    ...
    public static function cacheKeyGenerateSingleRecordBySlug(string $key, string $secondKey, string $slug, ?Language $language = null)
    {
        $cacheKey = "{$key}:{$secondKey}:";
    ...
    public static function cacheKeyGenerateSingleRecordBySlugTree(string $key, string $secondKey, string | int $slugTree, ?Language $language = null)
    {
    ...
    public static function cacheKeyGenerateSingleRecordByUseAs(string $key, string $secondKey, string $useAs, ?Language $language = null)
    {
        $cacheKey = "{$key}:{$secondKey}:";
    ...
    public static function cacheKeyGenerateForRecordByLimitAccrodingNewsPlacement(string $key, string $secondKey, string | null $pageName = null, string | null $pageSection = null, $category = null, int $limit = 4, ?Language $language = null): string
    {
    ...
    public static function cacheKeyGenerateForMaxDepthAndLevel(string $key, string $secondKey, $category = null, ?Language $language = null): string
    {
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateForNews(string $key, string $secondKey, Request $request, NewsType | Category | Tag | Contributor | Event | Location | null $filterModel = null, ?Language $language = null, int | null $perPage = null): string
    {
        $request ??= request();
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateForLastPageNoByFilter(string $key, string $secondKey, Request $request, NewsType | Category | Tag | Contributor | Event | Location | null $filterModel = null, ?Language $language = null): string
    {
        $request ??= request();
    ...
    public static function cacheKeyGenerateForRecordsLimitForTrend(string $key, string $secondKey, ?Language $language = null, int | null $limit = null): string
    {
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateSurveysByDate(string $key, string $secondKey, $date, ?Language $language = null)
    {
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateSurveyQuestionBySlugForSurvey(string $key, string $secondKey, $survey, $slug, ?Language $language = null)
    {
        $cacheKey = "{$key}:{$secondKey}";
        $cacheKey .= ":" . CacheHelper::KEY_SURVEY;
    ...
    public static function cacheKeyGenerateSingleRecordByMenuTypeCode(string $key, string $secondKey, string $menuTypeCode, ?Language $language = null)
    {
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateSingleMenuItemBySlug(string $key, string $secondKey, string $slug, ?Language $language = null)
    {
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateSingleMenuItems(string $key, string $secondKey, Menu $menu, MenuItem | null $menuItem = null, ?Language $language = null)
    {
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateThemes(string $key, string $secondKey)
    {
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateThemesByGroupAndLabels(string $key, string $secondKey, string $group, array $labels)
    {
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateThemesByGroupAndLabel(string $key, string $secondKey, string $group, string $label)
    {
        $cacheKey = "{$key}:{$secondKey}";
    ...
    public static function cacheKeyGenerateForBreakingNews(string $key, string $secondKey, ?Request $request = null, ?Language $language = null, int $perPage = 10)
    {
        $request ??= request();
    ...
    public static function cacheKeyGenerateGoogleAdsencesByTypeAndPosition(string $key, string $secondKey, string $type, string $position)
    {
        $cacheKey = "{$key}:{$secondKey}";
