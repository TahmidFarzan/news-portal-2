...
class GoogleAdPolicy
{
    ...
    public function update(User $authUser, GoogleAd $googleAd): Response
    {
        $module = UserPermissionHelper::MODULE_GOOGLE_AD;
    ...
    public function delete(User $authUser, GoogleAd $googleAd): Response
    {
