...
class SurveyQuestionPolicy
{
    ...
    {
        $module = UserPermissionHelper::MODULE_SURVEY_QUESTION;
        $access = UserPermissionHelper::ACCESS_VIEW_ANY;

        return $authUser->hasUserPermission($module, $access) ? Response::allow() : Response::deny();
    }

    public function view(User $authUser, SurveyQuestion $surveyQuestion): Response
    {
        $module = UserPermissionHelper::MODULE_SURVEY_QUESTION;
    ...
    public function update(User $authUser, SurveyQuestion $surveyQuestion): Response
    {
        $module = UserPermissionHelper::MODULE_SURVEY_QUESTION;
    ...
    public function delete(User $authUser, SurveyQuestion $surveyQuestion): Response
    {
        $module = UserPermissionHelper::MODULE_SURVEY_QUESTION;
